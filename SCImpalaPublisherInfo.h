...
- (id)initWithBusinessProfileId:(id)arg1 publisherId:(long long)arg2 publisherName:(id)arg3 publisherFormalName:(id)arg4 publisherDescription:(id)arg5 logoURL:(id)arg6 deeplinkURL:(id)arg7 unskippableAdsEnabled:(_Bool)arg8;
