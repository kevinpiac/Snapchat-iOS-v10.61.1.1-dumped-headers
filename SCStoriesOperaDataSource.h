...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSString, SCContextSession, SCOperaEventListenerAnnouncer, SCOperaPerformanceTrackingPlugin, SCSearchFriendProvider, SCStoriesAutoAdvanceLoader, SCStoriesOperaMediaManager, SCStoryLoader, SCStoryUserProperties, SCStreamingResourceLoader, SCUserSession, Story;
...
- (id)initWithViewingType:(long long)arg1 showViewersTable:(_Bool)arg2 storyPlayMode:(long long)arg3 firstStoryToDisplay:(id)arg4 userSession:(id)arg5 viewLocation:(long long)arg6 friendStoriesSectionMap:(id)arg7 enableCriticalModeWhenLoading:(_Bool)arg8 contextSession:(id)arg9 resourceLoader:(id)arg10;
