...
@class NSDate, NSString, SCBatchCaptureConfiguration, SCCameraOverlayView, SCCameraToolbarItem, SCCapturedBatchCaptureRecoveryData, SCDisposableObserverLifecycle, SCFeatureReference, SCLazy, SCLogger, SCManagedCapturerState, SCUserSession, UIView;
@protocol SCBatchCaptureUserPreferenceTimeProvider, SCCapturer, SCFeatureBatchCaptureDelegate, SCFeatureCameraBottomUIArbitrator, SCFeatureCameraToolbar, SCFeatureContainerView, SCFeatureMultiSnap;
...
- (long long)_batchCaptureSegmentCount;
...
- (id)initWithCapturer:(id)arg1 userSession:(id)arg2 multiSnap:(id)arg3 userPreferenceTimeProvider:(id)arg4 logger:(id)arg5 applicationLifecycleEvents:(id)arg6 cameraUserActionLogger:(id)arg7;
