...
@class NSString, SCExperimentManager, SCLazy, SCPreferences;
@protocol SCActionHandling, SCImageDownloading, SCLegacyItemDownloading, SCSnapchattersDataSearching;

@interface SCAddFriendsV2SearchSectionCreator : NSObject <SCSearchSectionCreating>
{
