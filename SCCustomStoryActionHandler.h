...
- (id)initWithPrivateStoriesSelectionPresenter:(id)arg1 customStoriesDataMutator:(id)arg2 customStoriesDataFetcher:(id)arg3 currentUsername:(id)arg4 currentUserId:(id)arg5;
