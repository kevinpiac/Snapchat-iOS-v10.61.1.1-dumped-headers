...
@class NSArray, NSString, SCGrowingButton, SCMapCompassButton, SCMapFooterActionButton, SCMapLocalityAndWeatherView, UIButton, UILabel, UIView;
...
@property(readonly, nonatomic) NSArray *overlayViewsForShareController;
