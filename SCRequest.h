...
@class NSDictionary, NSString, NSURLSessionTask, SCAPIRequestInfo, SCAPIURLSession, SCDisplayContext, SCRequestInfoContainer, SCRequestSchedulingStateListenerAnnouncer, SCRequestTrackingInfo;
...
- (id)queueType;
@property(nonatomic) long long queueingLatency; // @synthesize queueingLatency=_queueingLatency;
...
- (void)resumeWithCompletionQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2 preparationQueue:(id)arg3;
