...
@class NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, NSString, SCChatConversationStoreListenerAnnouncer, SCChatV3FeedUpdater, SCChatV3MessageReceiver;
@protocol SCChatConversationFetcher, SCChatExternalAPIProvider, SCConversationStorage, SCGroupManager, SCPerforming, SCUserHelperProtocol;
...
- (void)configureWithConversationFetcher:(id)arg1 messageReceiver:(id)arg2 feedUpdater:(id)arg3 userHelper:(id)arg4 groupManager:(id)arg5 lazyDocObjectContext:(id)arg6 username:(id)arg7 externalAPIProvider:(id)arg8;
