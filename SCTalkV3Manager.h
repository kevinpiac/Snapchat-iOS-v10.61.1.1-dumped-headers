...
@class NSMutableArray, NSMutableDictionary, NSString, SCTV3ActiveConversationsListenerAnnouncer, SCTV3AudioManager, SCTV3GlobalConfigurationUpdater, SCTV3MediaStatsViewController, TCV3PresenceService, TCV3TalkCore;
...
- (id)identityServices;
- (id)initWithUserId:(id)arg1 username:(id)arg2 audioServices:(id)arg3 avatarServices:(id)arg4 cameraServices:(id)arg5 chatTransportServices:(id)arg6 identityServices:(id)arg7 instrumentationServices:(id)arg8 networkServices:(id)arg9 phoneCallServices:(id)arg10 talkRPC:(id)arg11 isBark:(_Bool)arg12;
