...
@class CADisplayLink, NSDate, NSMutableDictionary, NSString, SCDiscoverFeedActionHandler, SCDiscoverFeedDebugInfoDataProvider, SCDiscoverFeedDeeplinkHandler, SCDiscoverFeedManagementActionSheetActionHandler, SCDiscoverFeedOnboardingDataCoordinator, SCDiscoverFeedPaginationController, SCDiscoverFeedPerformanceLoggerAdaptor, SCDiscoverFeedQueryCoordinator, SCDiscoverFeedSectionHeaderActionHandler, SCDiscoverFeedSectionViewAllButtonStates, SCDiscoverFeedView, SCDiscoverFeedViewControllerLoggingAdaptor, SCDiscoverTooltipManager, SCDynamicLayoutTransitionProvider, SCEventListenerAnnouncer, SCGCDBlockTimer, SCHovaTabBarView, SCLazy, SCPreviewTooltipBalloon, SCScopedAccess, SCScrollToEndDetector, SCSearchCardContainerContentViewControllerContext, SCSearchFriendProvider, SCSearchNetworkLogger, SCSearchQueryResultController, SCUserSession, UIScrollView, UIView;
@protocol NavigationDelegate, SCDiscoverFeedOperaViewingHandling, SCDiscoverFeedStoryPositionProviding, SCHovaOverscrollDelegate, SCReplyDelegate, SCStartChatDelegate, SCStoriesContentViewControllingDelegate, UIScrollViewDelegate;
...
- (void)_playAllUnviewedFriendStoriesWithRankedStoryIds:(id)arg1 friendStories:(id)arg2;
...
- (void)_presentPublicUserProfile:(id)arg1 businessProfileId:(id)arg2 isSubscribed:(_Bool)arg3 isOptedInNotifications:(_Bool)arg4 isHidden:(_Bool)arg5 presentingViewController:(id)arg6;
...
- (id)_toolTipForDiscoverFeedManagement:(unsigned long long)arg1;
