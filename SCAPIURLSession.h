...
@class NSMapTable, NSString, NSURLSession, NSURLSessionConfiguration, SCAPISessionTaskBookkeeper, SCCrNetFrameworkController, SCNetworkObservationBufferStore;
@protocol SCPerforming;

@interface SCAPIURLSession : NSObject <SCNetworkConnectivityListener, NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    ...
    SCNetworkObservationBufferStore *_networkObservationBufferStore;
    _Bool _isUsingCrNet;
...
- (double)_determinTimeoutInterval;
