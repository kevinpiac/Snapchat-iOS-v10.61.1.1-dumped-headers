...
@class LSABitmoji3DComponent, LSABitmojiEffectComponent, NSString, SCBitmojiService, SCLens;
...
- (id)initWithBitmojiEffectComponent:(id)arg1 bitmoji3DComponent:(id)arg2 dataFetcher:(id)arg3 lensUserProvider:(id)arg4 bitmojiImageFetcher:(id)arg5 bitmojiService:(id)arg6;
