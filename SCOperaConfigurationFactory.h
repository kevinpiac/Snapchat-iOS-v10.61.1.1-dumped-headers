...
@protocol SCLensExplorerLensUnlockerProtocol, SCOperaDeviceOrientationMonitor, SCOperaGlobalConfiguration, SCOperaRemoteVideoPropertiesProvider, SCOperaSafeBrowsingChecker;
...
- (id)initWithOperaSafeBrowsingChecker:(id)arg1 operaRemoteVideoPropertiesProvider:(id)arg2 operaDeviceOrientationMonitor:(id)arg3 operaGlobalConfiguration:(id)arg4 lensExplorerUnlocker:(id)arg5 experimentManager:(id)arg6;
