...
- (void).cxx_destruct;
- (void)_cancelCurrentUpdateBlockIfNecessary;
- (double)_delayForUpdate;
- (void)_handleAnimationUpdateRequest;
...
- (void)_scheduleConversationUpdate;
- (void)_unsetActiveConversation:(id)arg1;
...
- (void)clear;
- (void)configureWithExternalAPIProvider:(id)arg1 username:(id)arg2 userId:(id)arg3 groupManager:(id)arg4 messageViewModelFactory:(id)arg5 blockAssigner:(id)arg6 animationDataCoordinator:(id)arg7 storiesDataCoordinator:(id)arg8 arroyoConversationIdsManager:(id)arg9;
