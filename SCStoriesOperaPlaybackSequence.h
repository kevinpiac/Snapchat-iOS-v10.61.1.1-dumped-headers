...
@class SCStoriesPlaybackCustomStorySequence, SCStoriesPlaybackUserStorySequence;
...
- (void)matchFriendMergedStory:(CDUnknownBlockType)arg1 groupChatStory:(CDUnknownBlockType)arg2 customStory:(CDUnknownBlockType)arg3;
- (id)xLogObjectInfo;
