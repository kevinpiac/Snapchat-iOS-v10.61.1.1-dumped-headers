...
@protocol SCActionHandling, SCAudioSession, SCEventListener, SCImageDownloading, SCNotificationManager, SCOperaActivelyDisplayMediaStrategy, SCOperaContextMenuOverlayProvider, SCOperaCriticalModeOperator, SCOperaDeviceOrientationMonitor, SCOperaGLCommandsProvider, SCOperaGifProvider, SCOperaHtmlProvider, SCOperaImageProvider, SCOperaLoadingProgressProvider, SCOperaNetworkRadioStatusEstimationOperator, SCOperaPrefetcherSettingsProvider, SCOperaRemoteVideoPreloadStrategy, SCOperaRemoteVideoPropertiesProvider, SCOperaSafeBrowsingChecker, SCOperaShakeToReportOperator, SCOperaSnapLabeling, SCOperaSnappablesPlugin, SCOperaUpNextGroupViewModelProvider, SCOperaVideoAssetProvider, SCOperaViewModelsManipulator, SCOperaWebViewFaviconProvider, SCOperaWebViewPKPassProvider, SCOperaWebViewURLInterceptor, SCPageViewLogging;
...
@property(retain, nonatomic) id <SCOperaWebViewPKPassProvider> pkPassProvider; // @synthesize pkPassProvider=_pkPassProvider;
...
@property(readonly, nonatomic) unsigned long long scrollAnimationType; // @synthesize scrollAnimationType=_scrollAnimationType;
...
@property(retain, nonatomic) id <SCOperaUpNextGroupViewModelProvider> upNextGroupViewModelProvider; // @synthesize upNextGroupViewModelProvider=_upNextGroupViewModelProvider;
...
@property(readonly, nonatomic) _Bool usePreciseSeeking; // @synthesize usePreciseSeeking=_usePreciseSeeking;
