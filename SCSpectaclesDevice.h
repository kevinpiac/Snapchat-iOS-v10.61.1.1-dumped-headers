...
@class NSData, NSDate, NSMutableArray, NSMutableSet, NSNumber, NSString, NSUUID, SCSpectaclesAmbaWatchdog, SCSpectaclesAncsNotificationSettings, SCSpectaclesBleMonitor, SCSpectaclesBluetoothMonitor, SCSpectaclesCalibration, SCSpectaclesContentStore, SCSpectaclesDeviceEventListenerAnnouncer, SCSpectaclesFirmwareUpdater, SCSpectaclesFirmwareVersion, SCSpectaclesHardwareVersion, SCSpectaclesRequestMessage, SCSpectaclesTask, SCSpectaclesTaskQueue, SCSpectaclesTransferProgressMonitor, SCSpectaclesWifiMonitor, SCWeakTimer;
@protocol SCPerforming, SCSpectaclesLibraryLogger, SCSpectaclesNetworkClient, SCSpectaclesPeripheral, SCSpectaclesTweaksConfigProvider;
