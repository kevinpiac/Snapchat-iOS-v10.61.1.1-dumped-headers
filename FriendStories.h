...
- (void)backgroundFetchMediaWithMeida:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)fetchMedia:(id)arg1 withRequestBatchId:(id)arg2 userInitiated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
