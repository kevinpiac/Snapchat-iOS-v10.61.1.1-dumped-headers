...
- (id)_imageFromPbMediaRenderInfo:(id)arg1;
...
- (id)parseAdRenderData:(id)arg1 adIdentifier:(id)arg2 serveItemId:(id)arg3 adServeRequestId:(id)arg4 adProductType:(unsigned long long)arg5 experimentSettings:(id)arg6;
- (id)parseAndSelectOptimalRendition:(id)arg1 experimentSettings:(id)arg2 enableStreaming:(_Bool)arg3;
