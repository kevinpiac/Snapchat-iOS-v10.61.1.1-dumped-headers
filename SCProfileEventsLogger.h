...
- (void)logMiniProfileAddFriendButton:(id)arg1 profileId:(id)arg2 viewLocation:(long long)arg3 logProfileId:(_Bool)arg4 shouldAttributeViewToOurStory:(_Bool)arg5;
- (void)logMiniProfileChatButton:(id)arg1 friend:(id)arg2;
- (void)logMiniProfileExit:(id)arg1 friend:(id)arg2 openTime:(double)arg3 profileId:(id)arg4 logProfileId:(_Bool)arg5 profilePageType:(long long)arg6;
- (void)logMiniProfileSendAccount:(id)arg1 friend:(id)arg2;
- (void)logMiniProfileSettingsGearButton:(id)arg1 friend:(id)arg2;
...
- (void)logMiniProfileSnapButton:(id)arg1 friend:(id)arg2;
- (void)logMiniProfileView:(id)arg1 viewLocation:(long long)arg2 profileType:(long long)arg3 profileId:(id)arg4 logProfileId:(_Bool)arg5 shouldAttributeViewToOurStory:(_Bool)arg6;
