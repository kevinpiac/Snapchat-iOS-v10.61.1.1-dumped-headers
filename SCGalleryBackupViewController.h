...
@interface SCGalleryBackupViewController : SCGalleryLeftSwipableViewController <SCHeaderDelegate, SCHeaderDataSource, SCNetworkConnectivityListener, SCCloudSyncStatusListener, SCTraceEnabled>
{
