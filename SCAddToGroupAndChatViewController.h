...
@protocol NavigationDelegate, SCActionHandling, SCChatMainViewControllerStateDelegate, SwipeView;

@interface SCAddToGroupAndChatViewController : UIViewController <SCAddToGroupViewControllerDelegate, SCChatMainViewControllerStateDelegate, UIGestureRecognizerDelegate, SCTraceEnabled, SCInvalidFriendAlertViewDelegate, SCNewGroupViewControllerDelegate, SCCaptureWorkflowResultDelegate>
{
    SCAddToGroupViewController *_addToGroupVC;
    SCNewGroupViewController *_newGroupUnifiedSubpageVC;
