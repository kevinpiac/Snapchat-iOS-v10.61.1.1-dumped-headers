...
@interface SCSearchWebCardSectionDataProvider : NSObject <SCSectionDataProviding>
{
...
- (void).cxx_destruct;
- (void)_configureWebCardCollectionViewCell:(id)arg1;
- (id)_containerViewModelAtIndexPath:(id)arg1;
- (void)_updateWithWebCardSection:(id)arg1;
