...
@class NSString, SCFriendsTableIndex, SCGradientView, SCSendConfirmationView, SCSendSuggestionView, SCSendToPreviewPopupView, UICollectionView, UIImageView;
...
- (id)initWithFriendsTableIndexView:(id)arg1 confirmationViewConfig:(id)arg2;
- (id)initWithFriendsTableIndexView:(id)arg1 confirmationViewConfig:(id)arg2 sendToViewStyle:(unsigned long long)arg3;
- (id)initWithFriendsTableIndexView:(id)arg1 confirmationViewConfig:(id)arg2 sendToViewStyle:(unsigned long long)arg3 shouldEnableV11Theme:(_Bool)arg4;
