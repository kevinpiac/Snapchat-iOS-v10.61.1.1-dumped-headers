...
@class NSMutableDictionary, NSMutableSet, NSString, SCBitmojiDownloadQueue, SCBitmojiJobCollector, SCBitmojiMetricsCollector, SCBitmojiMetricsReporter, SCBitmojiNetworkPolicy, SCDisposableObserver, SCLazy, SCWeakTimer;
@protocol OS_dispatch_queue, SCBitmojiAvatarProvider, SCBitmojiNetworkStrategy, SCBitmojiPerformanceDebugProtocol;
...
- (id)initSelfCache:(id)arg1 friendCache:(id)arg2 avatarProvider:(id)arg3 requestManager:(id)arg4 performanceController:(id)arg5;
- (void)invalidate;
