...
@class NSString, SCLazy, SCPreviewTooltipBalloon, SCSearchContentViewControllerContext, SCSearchMultiStateView, SCSearchNavigationBarButtonItem, SCSendToConfirmationViewModelConverter_legacy, SCSendToDocObjectRecipientDataSource, SCSendToSelectionStateManager, SCUserSession, UIView;
