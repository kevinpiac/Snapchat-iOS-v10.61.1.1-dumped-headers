...
@interface SCCheetahSendToLastRecipientsSectionDataProvider : NSObject <SCUserSelectionListener, SCEventListener, SCSectionDataProviding>
{
...
- (id)initWithUserSession:(id)arg1 selectionStateManager:(id)arg2;
