...
@interface MobileSettingsViewController : SCGenericSettingsViewController <SCCountryCodePickerViewDelegate, UITextFieldDelegate, SCVerificationCodeTextFieldDelegate, UIScrollViewDelegate, TTTAttributedLabelDelegate, SCSettingsPasswordReauthViewControllerDelegate>
{
