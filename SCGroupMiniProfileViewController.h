...
@class NSArray, NSString, SCAddToGroupViewController, SCEditGroupAlertController, SCGroupMiniProfileGroupStorySectionController, SCGroupMiniProfileParticipantsSectionController, SCGroupStoryPublication, SCMiniProfileChatOptionsSectionController, SCOperaPresenter, SCSnapchatterMiniProfileActionHandler, SCUserSession;
@protocol SCChatGroup, SCGroupMiniProfileViewControllerDelegate;
