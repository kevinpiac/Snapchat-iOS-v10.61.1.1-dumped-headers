...
+ (void)overlayAndVideoTrackedImagesForOverlayState:(id)arg1 overlaySize:(struct CGSize)arg2 outputSize:(struct CGSize)arg3 useOutputSizeForStaticOverlay:(_Bool)arg4 userSession:(id)arg5 multiSnapDrawingCache:(id)arg6 croppingState:(id)arg7 venueFilterTooltipProvider:(id)arg8 completion:(CDUnknownBlockType)arg9;
- (void).cxx_destruct;
