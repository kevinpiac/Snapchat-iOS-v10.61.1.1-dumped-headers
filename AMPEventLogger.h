...
- (void)uploadEventBatchScheduleOrStartImmediately:(_Bool)arg1;
- (void)uploadEventBatchScheduleOrStartImmediately:(_Bool)arg1 bgPrefetch:(_Bool)arg2;
