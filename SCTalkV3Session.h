...
@class NSString, SCTCallButtons, SCTCallingController, SCTCognacController, SCTV3AudioManager, SCTV3CameraManager, SCTV3FullscreenController, SCTV3SessionWrapper, SCTV3SpeechActivityListenerAnnouncer, SCTV3UIController;
...
@interface SCTalkV3Session : NSObject <SCTV3SessionWrapperListener, SCTCallingControllerDelegate, SCTCallButtonsDelegate, SCTraceEnabled, SCTalkSession>
{
    ...
    SCTCognacController *_cognacController;
