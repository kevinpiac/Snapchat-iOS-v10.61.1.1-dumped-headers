...
@class NSArray, NSData, NSNumber, NSString, SCSpectaclesAncsNotificationRule, SCSpectaclesContextNotificationAnimation, SCSpectaclesFirmwareVersion;
...
+ (id)firmwareScheduleUpdate:(double)arg1 windowLength:(double)arg2 targetVersion:(SCSpectaclesFirmwareVersion *)arg3 targetDigest:(NSString *)arg4;
+ (id)getClientId;
