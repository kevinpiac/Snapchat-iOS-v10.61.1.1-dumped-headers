...
@class NSString, SCDownloadConsumptionRecorder, SCNetworkRequestRankingLogger, SCRequestManagerLogger, SCRequestScheduler;
...
@property(retain, nonatomic) SCNetworkRequestRankingLogger *networkRequestRankingLogger; // @synthesize networkRequestRankingLogger=_networkRequestRankingLogger;
...
- (void)runTask:(id)arg1 withCompletionQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3 preparationQueue:(id)arg4;
