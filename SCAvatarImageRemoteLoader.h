...
- (void)_fetchSelfieWithUserId:(id)arg1 avatarId:(id)arg2 selfieId:(id)arg3 type:(unsigned long long)arg4 contexts:(id)arg5 feature:(long long)arg6 canUsePrior:(_Bool)arg7 modifier:(unsigned long long)arg8 callbackQueue:(id)arg9 completion:(CDUnknownBlockType)arg10;
