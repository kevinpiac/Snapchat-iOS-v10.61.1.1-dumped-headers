...
@interface SCMyUnifiedProfileMapSectionDataProvider : NSObject <SCMapStatusFetchingListener, SCLocationPermissionObserver, SCLocationSharingPreferencesListener, SCSectionDataProviding>
{
