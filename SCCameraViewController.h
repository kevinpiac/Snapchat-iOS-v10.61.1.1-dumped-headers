...
#import "SCFeatureLensButtonZDelegate-Protocol.h"
...
- (void)didPostStories;
- (void)didPostStory;
- (void)didPostStoryAnimationDidComplete;
...
- (void)didUpdateCarouselVisibilityForState:(id)arg1;
...
- (void)featureLensZButton:(id)arg1 didPressLensButton:(id)arg2;
...
- (id)initWithFeatureProvider:(struct SCFeatureProvider *)arg1 startupWorkflow:(id)arg2;
...
@property(readonly, nonatomic) id <SCFeatureLensMainCarouselActivatorDelegate> lensActivatorDelegate;
...
- (id)lensUserProvider;
- (void)lensWillUnlock;
@property(readonly, nonatomic) id <SCFeatureLensButtonZDelegate> lensZButtonDelegate;
...
- (_Bool)shouldUpdateCarouselVisibilityAnimated;
