...
@interface ContactsViewController : UIViewController <SCSnapchattersDataRequestListener, EGORefreshTableHeaderDelegate, SCFriendProfileCellViewDelegate, SCIndexedTableViewDataSource, SCIndexedTableViewDelegate, SCSearchFriendsSubViewControllerDelegate, SendTextControllerDelegate, Subview>
{
