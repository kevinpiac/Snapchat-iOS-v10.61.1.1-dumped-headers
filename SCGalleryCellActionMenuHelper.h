...
#import "SCGallerySelectEntriesViewControllerDelegate-Protocol.h"
...
@protocol SCGalleryCellActionMenuHelperDataSource, SCGalleryCellActionMenuHelperDelegate, SCGalleryEntry, SCGalleryItem, SCKeyServiceRequest;

@interface SCGalleryCellActionMenuHelper : NSObject <SCGalleryCellActionMenuDelegate, SCGalleryCellActionMenuDataSource, SCGalleryPreviewControllerDelegate, SCGallerySelectEntriesViewControllerDelegate, UIViewControllerTransitioningDelegate, SCGalleryPrivateGallerySetupFlowDelegate, SCSpectaclesEventListener>
{
