...
@class Friend, FriendStories, SCMiniProfileStoryRelatedSnapchattersSectionController, UIView;
...
- (void)relatedSnapchattersSectionController:(SCMiniProfileStoryRelatedSnapchattersSectionController *)arg1 didTapPlayFriendStories:(FriendStories *)arg2 originalFriend:(Friend *)arg3 withBaseView:(UIView *)arg4;
@end
