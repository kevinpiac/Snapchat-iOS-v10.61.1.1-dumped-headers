...
@class NSString, SCActionModel, SCEventListenerAnnouncer, SCNetworkImageView, UIImageView, UILabel;
@protocol SCActionHandling, SCImageDownloading;

@interface SCSearchWebCardViewCell : SCSearchCollectionViewCell <SCActionable, SCEventAnnouncing, SCEventListener>
{
