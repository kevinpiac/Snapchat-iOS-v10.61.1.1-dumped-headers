...
- (void)_playFriendStories:(id)arg1 withBaseView:(id)arg2 viewLocation:(long long)arg3;
...
- (void)relatedSnapchattersSectionController:(id)arg1 didTapPlayFriendStories:(id)arg2 originalFriend:(id)arg3 withBaseView:(id)arg4;
