...
#import "SOJUGalleryServletGrantSharedSnapSaveResponse-Protocol.h"

@class NSNumber, NSString, SOJUGalleryServletQuota;

@interface SOJUGalleryServletGrantSharedSnapSaveResponse : NSObject <SOJUGalleryServletGrantSharedSnapSaveResponse>
{
...
- (id)initWithServiceStatusCode:(id)arg1 userString:(id)arg2 backoffTime:(id)arg3 debugInfo:(id)arg4 quota:(id)arg5 totalEntryCount:(id)arg6 encryption:(id)arg7;
