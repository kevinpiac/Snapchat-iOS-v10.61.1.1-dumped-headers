...
@class SCCommerceBitmojiViewModelProvider, SCCommerceScopedOptionsDataCoordinator, SCCompositeNetworkImageDownloader, SCUserSession;
...
@interface SCCommerceDependencyManager : NSObject
{
    ...
    SCCompositeNetworkImageDownloader *_compositeNetworkImageDownloader;
}
...
- (id)compositeNetworkImageDownloader;
