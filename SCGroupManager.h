...
@class NSDictionary, NSMutableDictionary, NSString, SCArchiveLoader, SCArroyoGroupDataFetcher, SCGroupLeaveStateTracker, SCGroupManagerListenerAnnouncer, SCGroupSyncStateTracker, SCLazy, SCPreferences, SCQueuePerformer, SCSessionRequestManager;
@protocol SCGroupLogger, SCGroupManagerAPI, SCGroupsStorageV3;
...
- (void)configureWithLazyDocObjectContext:(id)arg1 nativeSessionManager:(id)arg2 arroyoConversationIdsManager:(id)arg3 lazySnapchattersDataFetcher:(id)arg4 lazySnapchatterUserInfoProvider:(id)arg5 lazySnapchatterPublicInfoFetcher:(id)arg6 groupsDataTracker:(id)arg7 sessionRequestManager:(id)arg8 managerAPI:(id)arg9 logger:(id)arg10 selfUsername:(id)arg11 selfUserId:(id)arg12 userPreferences:(id)arg13;
