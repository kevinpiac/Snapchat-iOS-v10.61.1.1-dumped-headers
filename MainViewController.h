...
#import "SCOneToManyChatPresenterDelegate-Protocol.h"
...
- (void)_logNotificationEventsWithConversation:(id)arg1 snapId:(id)arg2 loadedMediaIds:(id)arg3;
...
- (_Bool)_presentAddFriendsCardForNotification;
- (_Bool)_presentAddFriendsTab;
...
- (void)handleOpenAddFriendsCardWithPlacement:(long long)arg1;
