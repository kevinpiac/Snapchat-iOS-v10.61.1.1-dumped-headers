...
@class NSString, SCCORECompositeStoryId, SCSSMCardDebugInfo, SCSSMClientDisplayInfo, SCSSMClientRankingFeatures, SCSSMCognacCard, SCSSMJaguarClientLogging, SCSSMLensChallengeCard, SCSSMLensChallengeStoryCard, SCSSMLensObjectCard, SCSSMMapTileCard, SCSSMMomentStoryCard, SCSSMOurStoryCard, SCSSMPivotCard, SCSSMPromotedStoryCard, SCSSMPublicUserStoryCard, SCSSMPublisherStoryCard, SCSSMSelectionCard, SCSSMSoloStoryCard, SCSSMStoryCard_TapAction;
