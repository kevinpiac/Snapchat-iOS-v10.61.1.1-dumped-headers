...
@class NSString, SCContextV2Session, UIViewController;
@protocol SCContextV2ActionsHandlerDelegate;

@interface SCContextV2ActionsHandler : NSObject <SCContextV2ModalDocumentViewControllerDelegate, SCContextV2DeepLinkHandlerDelegate, NSCopying, SCContextCTAViewContext, SCContextCardsViewContext>
{
...
- (void)deepLinkHandlerDidPresentModalContent:(id)arg1 triggerInfo:(id)arg2;
