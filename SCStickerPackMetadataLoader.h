...
- (id)initWithMetadataCache:(id)arg1 downloadStrategy:(id)arg2 throttleInfo:(id)arg3 requestManager:(id)arg4;
- (id)initWithMetadataCache:(id)arg1 downloadStrategy:(id)arg2 throttleInfo:(id)arg3 requestManager:(id)arg4 processingQueue:(id)arg5 subscriptionPerformer:(id)arg6;
