...
@class SCOperaPlaylistItem, SCOperaPlaylistItemGroup;

@protocol SCOperaPlaylistAdInsertionProtocol <NSObject>
- (void)startViewingPlaylistItem:(SCOperaPlaylistItem *)arg1;
- (void)startViewingPlaylistItemGroup:(SCOperaPlaylistItemGroup *)arg1 previousItemGroup:(SCOperaPlaylistItemGroup *)arg2;
