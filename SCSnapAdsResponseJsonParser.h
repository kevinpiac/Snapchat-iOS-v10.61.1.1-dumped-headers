...
+ (id)parseMediaUrl:(id)arg1 adProductType:(unsigned long long)arg2 renditionSelector:(id)arg3 experimentSettings:(id)arg4 enableStreaming:(_Bool)arg5;
...
+ (id)parseResponseJson:(id)arg1 adIdentifier:(id)arg2 serveItemId:(id)arg3 adServeRequestId:(id)arg4 adProductType:(unsigned long long)arg5 renditionSelector:(id)arg6 experimentSettings:(id)arg7;
+ (id)parseStringListParam:(id)arg1 paramName:(id)arg2;
- (void).cxx_destruct;
- (id)_parseResponseData:(id)arg1 adIdentifier:(id)arg2 serveItemId:(id)arg3 adServeRequestId:(id)arg4 adProductType:(unsigned long long)arg5 experimentSettings:(id)arg6;
...
- (id)parseProtoResponse:(id)arg1 adIdentifier:(id)arg2 serveItemId:(id)arg3 adServeRequestId:(id)arg4 adProductType:(unsigned long long)arg5 experimentSettings:(id)arg6;
- (id)parseResponseJsonString:(id)arg1 adIdentifier:(id)arg2 serveItemId:(id)arg3 adServeRequestId:(id)arg4 adProductType:(unsigned long long)arg5 experimentSettings:(id)arg6;
