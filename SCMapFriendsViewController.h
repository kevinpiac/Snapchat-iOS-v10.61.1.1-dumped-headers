...
@class NSArray, NSDictionary, NSMutableSet, NSString, SCFriendsTableIndex, SCMapFloatingActionButton, SCMapModalViewController, SCSearchBar, UIImage, UILabel, UITableView, UIView;
...
- (id)initWithSelectionStyle:(long long)arg1 currentUserId:(id)arg2 mapFriendsProvider:(id)arg3 mapPersonLocationsProvider:(id)arg4;
