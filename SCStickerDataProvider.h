...
@interface SCStickerDataProvider : NSObject <SCStickerPickerMenuDataSource, SCStickerPickerV2IconsDataSource>
{
    ...
    _Bool _useBitmojiCategoryFirstOrdering;
...
- (id)initForChatWithUser:(id)arg1 recentStickers:(id)arg2 searchStickers:(id)arg3 chatStickerManager:(id)arg4 customStickers:(id)arg5 userSession:(id)arg6 bitmojiAvatarBuilderRouterDelegate:(id)arg7;
