...
@property(readonly, nonatomic) id <SCPreviewFeatureDepthDisplay> depthDisplayFeature;
...
@property(readonly, nonatomic) SCLazy *storiesSendToCoordinator;
