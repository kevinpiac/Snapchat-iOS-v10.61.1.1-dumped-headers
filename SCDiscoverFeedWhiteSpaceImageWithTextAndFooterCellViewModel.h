...
@class NSString, SCActionModel, SCDiscoverFeedDebugViewModel, SCDiscoverFeedStoryLoggingInfo, SCDiscoverFeedWhiteSpaceDynamicPostViewLayerViewModel, SCDiscoverFeedWhiteSpaceHeadlineViewModel, SCDiscoverFeedWhiteSpaceImageWithTextViewModel, SCDiscoverFeedWhiteSpaceProfileRowViewModel, SCDiscoverFeedWhiteSpaceSubscriptionIconViewModel, UIColor;

@interface SCDiscoverFeedWhiteSpaceImageWithTextAndFooterCellViewModel : NSObject <NSCopying>
{
