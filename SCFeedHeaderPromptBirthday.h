...
@class NSString, SCHeaderPromptView, SCHeaderPromptViewModel, SCLazy, SCLogger, SCUserSession;
...
- (id)initWithUserSession:(id)arg1 delegate:(id)arg2 userAdaptor:(id)arg3 promptStateProvider:(id)arg4 logger:(id)arg5;
