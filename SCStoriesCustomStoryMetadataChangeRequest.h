...
- (id)initWithRowid:(long long)arg1 publicationId:(id)arg2 type:(long long)arg3 mischiefId:(id)arg4 displayName:(id)arg5 subText:(id)arg6 metadataTimestamp:(double)arg7 creationInfo:(id)arg8 geoConfig:(id)arg9 currentUserCanPost:(_Bool)arg10 participants:(id)arg11 posterIdsPermitted:(id)arg12 viewerIdsPermitted:(id)arg13 isInactive:(_Bool)arg14 sortingHints:(id)arg15;
