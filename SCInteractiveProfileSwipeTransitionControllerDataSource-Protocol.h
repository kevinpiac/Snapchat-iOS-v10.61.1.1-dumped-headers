...
@class SCInteractiveProfileSwipeTransitionController, UIGestureRecognizer, UIViewController;
...
@optional
- (_Bool)shouldBeginTransitionWithSwipeTransitionController:(SCInteractiveProfileSwipeTransitionController *)arg1;
