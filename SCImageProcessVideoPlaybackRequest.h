...
- (void)dealloc;
- (id)initWithPixelBuffer:(struct __CVBuffer *)arg1 renderer:(id)arg2 orientation:(long long)arg3 presentationTime:(CDStruct_1b6d18a9)arg4 offset:(float)arg5 isOffsetLandscape:(_Bool)arg6 viewportTransform:(struct CGAffineTransform)arg7 intermediateCommands:(id)arg8 outputCommands:(id)arg9 preOutputCommands:(id)arg10 midOutputCommands:(id)arg11 displayTimestamp:(double)arg12 backgroundColor:(id)arg13 completionHandler:(CDUnknownBlockType)arg14;
