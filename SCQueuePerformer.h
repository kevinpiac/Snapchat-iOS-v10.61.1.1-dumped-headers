...
@interface SCQueuePerformer : NSObject <SCPerforming>
{
    ...
    unsigned long long _throttleStrategy;
    _Bool _throttled;
...
- (id)initWithLabel:(const char *)arg1 qualityOfService:(unsigned int)arg2 queueType:(id)arg3 context:(unsigned long long)arg4 throttleStrategy:(unsigned long long)arg5;
