...
@class NSDictionary, NSString, PreviewViewController, SCBaseUploadableChatMedia, SCDiscoverMediaBlob, SCDiscoverMediaMessagePrepper, SCExpandingPreviewAnimator, SCPreviewConfiguration, SCSendToTransitionProvider, SCUpdateListenerAnnouncer, SCUserSession, SnapTrophyMetrics, UIViewController;
@protocol SCDiscoverShareControllerDelegate, SCSendToScreen;
...
- (id)_previewConfigurationForImage:(id)arg1 snapSaverImageProvider:(CDUnknownBlockType)arg2 rotationEnabled:(_Bool)arg3 savingDisabled:(_Bool)arg4 snapPageSource:(long long)arg5;
...
- (void)shareWithImage:(id)arg1 overlayImages:(id)arg2 fromViewController:(id)arg3 touchOrigin:(struct CGPoint)arg4 rotationEnabled:(_Bool)arg5 snapSaverImageProvider:(CDUnknownBlockType)arg6 savingDisabled:(_Bool)arg7 snapPageSource:(long long)arg8;
