...
@class LSATouchProcessingController, NSString, SCAlertViewActionButtonController, SCFeatureReference, SCIdleTimerManager, SCLensBitmojiAlertUIController, SCLensBitmojiProvider, SCLensCarouselPresenter, SCLensCompassAndLocationProvider, SCLensCoreAnalyticsLogger, SCLensDownloadableContent, SCLensGeoDataProvider, SCLensHintPresenter, SCLensHintProvider, SCLensInCameraUsageNotifier, SCLensLayoutProvider, SCLensPhotoFaceImageProvider, SCLensPresetImageProvider, SCLensRemoteAssetsDataProvider, SCLensSbSnappable, SCLensStudioSyncManager, SCLensTapToActivateLogger, SCLensUIUpdateListenerAnnouncer, SCLensUriServiceProvider, SCLensUriServiceSonicAssetHandler, SCLensUserDataProvider, SCLensUserInterfaceTooltipPresenter, SCLensValidator, SCLensesUIControllerState, SCLoadingIndicatorView, SCPreferences, SCSponsoredSlugInteractiveView, UICollectionView, UILabel, UITapGestureRecognizer, UIView;
...
- (id)initWithParentViewContainer:(id)arg1 hidableViewContainer:(id)arg2 adInfoPresenter:(id)arg3 lensProcessingCore:(id)arg4 lensDataProvider:(id)arg5 lensLayoutProvider:(id)arg6 gestureRecognizerDelegate:(id)arg7 conversationMetadataProvider:(id)arg8 lensUserInterfaceDelegate:(id)arg9 lensCarousel:(id)arg10 lensUserProvider:(id)arg11 compassAndLocationProvider:(id)arg12 lensRemoteAssetsDataProvider:(id)arg13 lensBitmojiProvider:(id)arg14 uriServiceProvider:(id)arg15 snappablesFutureProvider:(id)arg16 textInputProvider:(id)arg17 sonicAssetHandler:(id)arg18 sharedStateControllerProvider:(id)arg19 lensUsageTracker:(id)arg20 lensUsageNotifier:(id)arg21 lensLogger:(id)arg22 lensUserDataProvider:(id)arg23 lensGeoDataProvider:(id)arg24 lensStudioSyncManager:(id)arg25 lensDownloadableContent:(id)arg26 lensDataFetcher:(id)arg27 userPreferences:(id)arg28 downloadableContentManager:(id)arg29;
- (id)initWithParentViewContainer:(id)arg1 hidableViewContainer:(id)arg2 adInfoPresenter:(id)arg3 userSession:(id)arg4 lensProcessingCore:(id)arg5 lensDataProvider:(id)arg6 lensLayoutProvider:(id)arg7 gestureRecognizerDelegate:(id)arg8 sceneIntelligence:(id)arg9 conversationMetadataProvider:(id)arg10 lensUserInterfaceDelegate:(id)arg11 lensCarousel:(id)arg12 lensUserProvider:(id)arg13;
