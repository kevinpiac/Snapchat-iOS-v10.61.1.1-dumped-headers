...
- (id)initWithConsistentId:(id)arg1 encryptedId:(id)arg2 messageSender:(id)arg3 conversationId:(id)arg4 recipientForOneOnOneChat:(id)arg5 knownChatSequenceNumbers:(id)arg6 messageTimestamp:(id)arg7 sentTimestamp:(id)arg8 sendStartTimestamp:(id)arg9 iterToken:(id)arg10 savedState:(id)arg11 releaseState:(id)arg12 preserveState:(id)arg13 snapState:(id)arg14 type:(long long)arg15 text:(id)arg16 attributes:(id)arg17 mediaCardAttributes:(id)arg18 media:(id)arg19 overlayMedia:(id)arg20 medias:(id)arg21 chatSticker:(id)arg22 groupUpdate:(id)arg23 snapMetadata:(id)arg24 encryptedGeoData:(id)arg25 storyTitle:(id)arg26 storyShare:(id)arg27 mediaSendTaskId:(id)arg28 snapchatterShare:(id)arg29 khaleesiShare:(id)arg30 nycShare:(id)arg31 searchSnapShare:(id)arg32 searchStoryShare:(id)arg33 mediaSave:(id)arg34 sendStatus:(long long)arg35 groupId:(long long)arg36 mischiefVersion:(unsigned long long)arg37 typeVersion:(id)arg38 shouldRetryMediaSendTask:(_Bool)arg39 isSnapEnvelopeReleased:(_Bool)arg40 snapServerId:(id)arg41 isPendingSnap:(_Bool)arg42 isSavedToMemories:(_Bool)arg43 replyMedias:(id)arg44 messageParcel:(id)arg45 isScreenRecording:(_Bool)arg46 screenCaptureSource:(long long)arg47 markedForDeletionByServer:(_Bool)arg48 retentionInMinutes:(unsigned long long)arg49;
- (_Bool)isActionable;
