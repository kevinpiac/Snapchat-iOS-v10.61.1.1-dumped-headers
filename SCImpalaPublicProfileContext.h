...
@protocol SCCFriendStoring, SCCLensActionHandling, SCCStoryPlayerPlaying, SCCStoryPlayerStorySnapViewStateProviding, SCComposerFoundationApplicationProtocol, SCImpalaChatActionHandling, SCImpalaCommerceActionHandling, SCImpalaPresentationControlling, SCImpalaPublicProfileActionHandling, SCImpalaPublicProfileHandlerProviding, SCImpalaUrlActionHandling;

@interface SCImpalaPublicProfileContext : NSObject <SCComposerJsConvertible, NSCopying>
{
