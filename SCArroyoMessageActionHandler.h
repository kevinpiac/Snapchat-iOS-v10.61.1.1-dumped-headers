...
@class SCArroyoMediaFetcher, SCBoltUploadManager, SCChatSendBlockAssigner, SCChatV3MetadataStore, SCNMessagingUUID, SCQueuePerformer;
@protocol SCArroyoCoreMessageActionHandling, SCNativeMessagingSessionManaging;
...
@interface SCArroyoMessageActionHandler : NSObject <SCChatMessageActionHandling, SCChatUIActionHandling>
{
    ...
    id <SCArroyoCoreMessageActionHandling> _arroyoCoreActionHandler;
...
- (void)_updateMetadataForFinishViewingSnap:(id)arg1 hasAvailableCredits:(_Bool)arg2;
...
- (id)initWithNativeSessionManager:(id)arg1 mediaFetcher:(id)arg2 metadataStore:(id)arg3 blockAssigner:(id)arg4 userId:(id)arg5 uploadManager:(id)arg6 coreActionHandler:(id)arg7;
