...
@property(nonatomic) _Bool hasAcceptedTermsOfUse;
...
@property(nonatomic) _Bool isUpdatingTermsOfUse;
...
@property(retain, nonatomic) NSDate *lastResurrectionAddFriendsRebadgeTriggerTimestamp;
...
@property(nonatomic) _Bool shouldTriggerResurrectionAddFriendsRebadge;
