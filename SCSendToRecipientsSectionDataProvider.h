...
@interface SCSendToRecipientsSectionDataProvider : NSObject <SCUserSelectionListener, SCSnapchattersDataRequestListener, SCGroupsDataRequestListener, SCSectionDataProviding>
{
