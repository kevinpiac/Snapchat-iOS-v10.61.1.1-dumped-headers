...
@interface SCLensExplorerOperaPresenter : NSObject <SCOperaPresenterDelegate, SCContextOperaPlaylistPluginDelegate, SCDiscoverFeedMiniProfileHandlerDelegate, SCLensExplorerOperaPresenterProtocol>
{
