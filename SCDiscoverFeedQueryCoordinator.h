...
- (void).cxx_destruct;
- (id)_createSectionFromResponse:(id)arg1 groupStoryPublications:(id)arg2 feedType:(int)arg3 query:(id)arg4;
...
- (void)_handleStoriesBatchResponse:(id)arg1 groupStoryPublications:(id)arg2 query:(id)arg3 updatingBlock:(CDUnknownBlockType)arg4;
- (void)_handleStoriesBatchResponse:(id)arg1 query:(id)arg2 updatingBlock:(CDUnknownBlockType)arg3;
- (void)_handleStoriesBatchResponseUpdatedWatchedStates:(id)arg1 groupStoryPublications:(id)arg2 query:(id)arg3 updatingBlock:(CDUnknownBlockType)arg4;
- (void)_handleStoriesResponse:(id)arg1 groupStoryPublications:(id)arg2 query:(id)arg3 updatingBlock:(CDUnknownBlockType)arg4;
- (void)_handleStoriesResponse:(id)arg1 query:(id)arg2 updatingBlock:(CDUnknownBlockType)arg3;
- (void)_handleStoriesResponseUpdatedWatchedStates:(id)arg1 groupStoryPublications:(id)arg2 query:(id)arg3 updatingBlock:(CDUnknownBlockType)arg4;
- (void)_invalidateQueryTimeoutTimer;
- (void)_logResponse:(id)arg1 query:(id)arg2;
- (void)_persistBatchResponse:(id)arg1 groupStoryPublications:(id)arg2 query:(id)arg3;
- (id)_persistSectionMetadataWithStoriesResponse:(id)arg1;
- (void)_persistStoriesToDataStoreWithStoriesResponse:(id)arg1 metaStreamToken:(id)arg2 groupStoryPublications:(id)arg3 query:(id)arg4;
...
- (id)initWithUserSession:(id)arg1 sectionExtensionServices:(id)arg2 discoverFeedDataCoordinator:(id)arg3 friendStoriesDataCoordinator:(id)arg4 docObjectContext:(id)arg5;
