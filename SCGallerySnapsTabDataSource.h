...
@class NSArray, NSDateFormatter, NSString, SCGalleryMomentClusterer, SCGallerySnapFeaturedStoriesSectionViewModel, SCMergedGalleryDataSource, SCUserSession;
...
- (id)_dateRangeForCluster:(id)arg1;
