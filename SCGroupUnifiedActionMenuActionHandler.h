...
@interface SCGroupUnifiedActionMenuActionHandler : NSObject <SCUnifiedActionMenuPresenterDelegate, SCUpdateListener, SCTraceEnabled, SCActionHandling, SCEventAnnouncing>
{
