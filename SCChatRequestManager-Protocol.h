...
@class NSArray, NSDictionary, NSNumber, NSString, SCChatMediaContent, SCChatMessageV3, SCExperimentManager, SCSessionRequestManager, SCSnapTokenManager;
...
- (void)sendSearchDownloadRequestForStoryId:(NSString *)arg1 snapId:(NSString *)arg2 conversationId:(NSString *)arg3 experimentManager:(SCExperimentManager *)arg4 requestManager:(SCSessionRequestManager *)arg5 snapTokenManager:(SCSnapTokenManager *)arg6 metadataCompletionBlock:(void (^)(_Bool, SCSearchStoryMetadata *))arg7 storyDownloadCompletionBlock:(void (^)(_Bool, SCStorySnapMediaContent *))arg8;
