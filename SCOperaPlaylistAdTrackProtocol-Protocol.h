...
@class NSDictionary, NSString, SCOperaPlaylistItem, SCOperaPlaylistItemGroup, SCOperaViewController, SCSnapAdsAdResponse;
...
- (SCSnapAdsAdResponse *)adResponseForGroup:(SCOperaPlaylistItemGroup *)arg1;
- (SCSnapAdsAdResponse *)adResponseForItem:(SCOperaPlaylistItem *)arg1;
