...
@class NSArray, NSDate, NSDictionary, NSNumber, NSSet, NSString, SCChatMediaContent, SCChatMessageParticipantIdentifier;
...
- (_Bool)isViewedOneOnOneOrSentGroupSnapBy:(NSString *)arg1;
- (_Bool)isViewing;
