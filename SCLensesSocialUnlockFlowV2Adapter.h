...
@class NSString;
@protocol SCContextV2SocialUnlockFlowDelegate, SCLensSocialUnlockV2Flow;
...
- (_Bool)startUnlockFlowForURL:(id)arg1 deepLinkUnlockPolicy:(id)arg2 baseViewController:(id)arg3 replyParameters:(id)arg4 delegate:(id)arg5;
