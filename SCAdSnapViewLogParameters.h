...
@class NSNumber, NSString, SCAdSnapAppInfoLogParameters, SCAdSnapAppInstallStatusLogParameters, SCAdSnapLoadStatusLogParameters;
...
@interface SCAdSnapViewLogParameters : NSObject <NSCopying>
{
    ...
    SCAdSnapAppInstallStatusLogParameters *_appInstallStatus;
...
@property(readonly, copy, nonatomic) SCAdSnapAppInstallStatusLogParameters *appInstallStatus; // @synthesize appInstallStatus=_appInstallStatus;
...
- (id)initWithMediaType:(long long)arg1 isFullViewAd:(_Bool)arg2 videoViewedTimeInSec:(double)arg3 topSnapDurationInSec:(double)arg4 totalTopSnapsDurationInSec:(double)arg5 isTopSnapFullyViewed:(_Bool)arg6 timeViewed:(double)arg7 isOnTopSnap:(_Bool)arg8 snapCount:(long long)arg9 loadStatus:(id)arg10 storyType:(long long)arg11 storyTypeSpecific:(long long)arg12 posterId:(id)arg13 viewLocation:(long long)arg14 autoAdvanceIndex:(long long)arg15 adIndexPos:(long long)arg16 adIndexCount:(long long)arg17 snapIndexPos:(long long)arg18 snapIndexCount:(long long)arg19 exitEvent:(long long)arg20 storySessionId:(id)arg21 publisherId:(id)arg22 editionId:(id)arg23 isArchivedChannel:(_Bool)arg24 channelDeepLinkId:(id)arg25 channelViewSource:(long long)arg26 editionEntrySnapIndex:(long long)arg27 adId:(id)arg28 adKey:(id)arg29 adPlacementId:(id)arg30 adLineItemId:(id)arg31 adRequestClientId:(id)arg32 adUnitId:(id)arg33 adProductSourceType:(long long)arg34 adReportFlaggedReason:(long long)arg35 adReportExitType:(long long)arg36 adReportExitLevel:(long long)arg37 adSkipReason:(long long)arg38 adInsertRetryCount:(long long)arg39 adShareEntryEvent:(long long)arg40 adShareRecipientCount:(long long)arg41 videoRollMinDegree:(double)arg42 videoRollMaxDegree:(double)arg43 logTapPosition:(_Bool)arg44 tapPositionX:(double)arg45 tapPositionY:(double)arg46 tapPositionXRelative:(double)arg47 tapPositionYRelative:(double)arg48 logCardMetrics:(_Bool)arg49 cardExitEvent:(long long)arg50 deepLinkFromCard:(_Bool)arg51 deepLinkFallBackToAppStore:(_Bool)arg52 deepLinkFallBackToWebview:(_Bool)arg53 cardLastVisibleTimeSec:(double)arg54 isCameraAd:(_Bool)arg55 appInstallStatus:(id)arg56 logInteractionZone:(_Bool)arg57 interactionZoneTotalItemCount:(long long)arg58 lastInteractiveItemIndex:(id)arg59 interactionZoneStyle:(long long)arg60 interactionZoneTotalViewCount:(long long)arg61 interactionZoneUniqueViewCount:(long long)arg62 interactionZoneMaxInteractedItemIndex:(long long)arg63 webViewPageLoadCount:(long long)arg64 webViewPageLoadErrorCount:(long long)arg65 webViewLoadedOnEntry:(_Bool)arg66 webViewLoadedOnExit:(_Bool)arg67 webViewVisiblePageLoadTimeInSec:(double)arg68 webViewUserPermissionPromptCount:(long long)arg69 webViewUserPermissionPromptAllowedCount:(long long)arg70 webViewAutofillDetectedFields:(id)arg71 webViewDetectedFields:(id)arg72 webViewOnEditAutofilledFields:(id)arg73 longformVideoDurationInSec:(double)arg74 longformVideoPartnerId:(id)arg75 longformVideoAspectRatio:(double)arg76 longformVideoCaptionTimeInSec:(double)arg77 longformVideoStartedWithCaption:(_Bool)arg78 longformVideoLandscapeTimeInSec:(double)arg79 appInfo:(id)arg80 lensIsLoadedOnEntry:(_Bool)arg81 lensIsLoadedOnExit:(_Bool)arg82 lensSessionId:(id)arg83 lensLoadTimeInSec:(double)arg84;
