...
- (id)initWithSuggestedFriendResults:(id)arg1 message:(id)arg2 logged:(id)arg3 suggestionPlacementToReasonMapping:(id)arg4 suggestedFriendResultsV2:(id)arg5 addFriendsFooterOrdering:(id)arg6 storiesPageOrdering:(id)arg7 sendToPageOrdering:(id)arg8 feedPageOrdering:(id)arg9 searchPageOrdering:(id)arg10 searchResultPageOrdering:(id)arg11 fullPageOrdering:(id)arg12 storiesViewAllPageOrdering:(id)arg13 friendsHorizontalPageOrdering:(id)arg14 friendsViewAllPageOrdering:(id)arg15 discoverCarouselStyle:(id)arg16 discoverCarouselClientImpression:(id)arg17 badgingStartIndex:(id)arg18 badgingEndIndex:(id)arg19 badgingType:(id)arg20;
