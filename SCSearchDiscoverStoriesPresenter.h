...
@class NSString, SCEventListenerAnnouncer, SCOperaPerformanceTrackingPlugin, SCOperaPlaylistCameraPlugin, SCOperaPlaylistCommercePlugin, SCOperaPlaylistEditionsPlugin, SCOperaPlaylistNotificationOptInPlugin, SCOperaPlaylistStoryProgressIndicatorPlugin, SCOperaPresenter, SCUserSession, SCViewControllerTransitionAnimator;
...
@interface SCSearchDiscoverStoriesPresenter : NSObject <SCOperaPresenterDelegate, SCEventListener, SCEventAnnouncing>
{
    ...
    SCOperaPlaylistStoryProgressIndicatorPlugin *_storyProgressIndicatorPlugin;
