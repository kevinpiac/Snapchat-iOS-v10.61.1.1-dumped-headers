...
@class FBKVOController, FriendStories, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, SCContextSession, SCDisposableObserverLifecycle, SCOperaPerformanceTrackingPlugin, SCOperaViewModel, SCSearchFriendProvider, SCStoriesOperaMediaManager, SCStoryLoader, SCStreamingResourceLoader, SCUserSession, Story;
@protocol SCDiscoverFeedStoryFetching, SCOperaLabelTextProvider, SCOperaPlaylistItemController, SCOperaViewProvider, SCSingleFriendStoriesOperaDataSourceDelegate, SCStreamingURLProviding;

@interface SCSingleFriendStoriesOperaDataSource : NSObject <SCStreamingURLProviding, SCTraceEnabled, SCStoryMediaStateListener, SCStorySaveCompleteListener, SCOperaPlaylistItemMediaPreparationController, SCOperaPlaylistItemGroupResolver>
{
...
- (id)initWithFriendStories:(id)arg1 viewingType:(long long)arg2 firstStoryToDisplay:(id)arg3 isInStoryPlaylistMode:(_Bool)arg4 performanceTrackingPlugin:(id)arg5 storyLoader:(id)arg6 isInOperaPlaylistMode:(_Bool)arg7 userSession:(id)arg8 viewLocation:(long long)arg9 chromeAvatarProvider:(id)arg10 groupChatTitleProvider:(id)arg11 contextSession:(id)arg12 resourceLoader:(id)arg13;
- (id)initWithStory:(id)arg1 showViewersTable:(_Bool)arg2 viewingType:(long long)arg3 performanceTrackingPlugin:(id)arg4 storyLoader:(id)arg5 isInOperaPlaylistMode:(_Bool)arg6 userSession:(id)arg7 viewLocation:(long long)arg8 chromeAvatarProvider:(id)arg9 groupChatTitleProvider:(id)arg10 contextSession:(id)arg11 resourceLoader:(id)arg12;
