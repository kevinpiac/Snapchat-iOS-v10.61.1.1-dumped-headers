...
+ (id)MessageContentWithContent:(id)arg1 contentType:(long long)arg2 remoteMediaInfo:(id)arg3;
- (void).cxx_destruct;
...
- (id)description;
- (id)initWithContent:(id)arg1 contentType:(long long)arg2 remoteMediaInfo:(id)arg3;
