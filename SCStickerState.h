...
+ (id)snapKitStickerStateWithData:(id)arg1;
+ (id)snapKitStickerStateWithData:(id)arg1 animated:(_Bool)arg2 center:(struct CGPoint)arg3 rotation:(double)arg4 relativeSize:(struct CGSize)arg5;
- (void).cxx_destruct;
