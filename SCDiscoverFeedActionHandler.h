...
@interface SCDiscoverFeedActionHandler : NSObject <SCMapViewControllerDelegate, SCSearchStoriesPresenterDelegate, SCOperaPresenterDelegate, SCDiscoverFeedDebugViewControllerDelegate, SCDiscoverFeedMiniProfileHandlerDelegate, SCSearchMomentsOperaPresenterDelegate, SCContextOperaPlaylistPluginDelegate, SCUpdateListener, SCMiniProfileViewControllerDelegate, SCDiscoverFeedMomentStoryActionHandlerDelegate, SCOpenUnifiedProfileActionHandlerDelegate, SCDiscoverFeedUnifiedProfileActionHandlerDelegate, SCDiscoverFeedActionHandling, SCEventAnnouncing, SCEventListener, SCCognacNotificationHandling>
{
    ...
    SCScopedAccess *_scopedStoriesDataCoordinatorLazy;
...
- (void)_playFriendStory:(id)arg1 withRankedFriendSummaryData:(id)arg2 actionModel:(id)arg3 baseView:(id)arg4;
...
- (void)_presentMyStoryActionSheet:(id)arg1;
...
- (void)_startChatWithGroupId:(id)arg1;
...
- (id)initWithUserSession:(id)arg1 friendProvider:(id)arg2 friendStoriesReplayManager:(id)arg3 navigationDelegate:(id)arg4 replyDelegate:(id)arg5 startChatDelegate:(id)arg6 scopedLazyStoriesDataCoordinator:(id)arg7 scopedLazyStoriesPlaybackDataProvider:(id)arg8 scopedLegacyStoriesPlaybackDataProvider:(id)arg9 scopedLazyDiscoverFeedDataCoordinator:(id)arg10 sectionViewAllButtonStates:(id)arg11 collapseManager:(id)arg12 storyPositionProvider:(id)arg13 operaViewingHandler:(id)arg14;
