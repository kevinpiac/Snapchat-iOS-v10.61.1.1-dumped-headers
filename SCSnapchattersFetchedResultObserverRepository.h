...
@class SCDocObjectContext, SCSnapchattersAToZObserver, SCSnapchattersCountSummaryObserver, SCSnapchattersFetchedResultObserver, SCSuggestedSnapchattersDataProvider;
