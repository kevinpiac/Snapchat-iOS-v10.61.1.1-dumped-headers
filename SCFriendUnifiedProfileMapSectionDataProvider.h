...
@interface SCFriendUnifiedProfileMapSectionDataProvider : NSObject <SCProfileLocationSharingControllerDataListener, SCMapStatusFetchingListener, SCMapPersonLocationsListener, SCProfileMapCardBitmojiLoaderDelegate, SCUpdateListener, SCSectionDataProviding>
{
