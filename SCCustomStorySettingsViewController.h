...
@protocol SCCustomStorySettingsViewControllerDelegate, SCGroupManager;
...
- (void)_didAttemptToKeepEditting;
...
- (void)_handleCustomStoryCreationResponse:(id)arg1 publication:(id)arg2;
...
- (void)_logCreationSessionWithPublication:(id)arg1;
- (id)_mapCell;
...
- (void)_updateCreationSessionWithPublication:(id)arg1;
...
- (id)initWithCreationContext:(long long)arg1 userSession:(id)arg2 creationSettings:(id)arg3 fromViewController:(id)arg4 createType:(long long)arg5 creationSession:(id)arg6 lazySnapchattersFetcher:(id)arg7 lazyGroupsDataCreator:(id)arg8 lazyGroupsDataMutator:(id)arg9 groupManager:(id)arg10 scopedLazyStoriesDataCoordinator:(id)arg11 customStoriesDataFetcher:(id)arg12;
- (id)initWithGroupStoryPublicationToEdit:(id)arg1 showExpanded:(_Bool)arg2 hideStories:(_Bool)arg3 userSession:(id)arg4 sourceType:(long long)arg5 fromContext:(long long)arg6;
