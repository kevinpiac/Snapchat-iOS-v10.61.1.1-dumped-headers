...
@interface SCRegisterAccountV2ViewController : UIViewController <SCRegisterSuggestedUsernameV2ViewDelegate, SCRegisterV2ViewDelegate, SCRegistrationAlertControllerDelegate>
{
