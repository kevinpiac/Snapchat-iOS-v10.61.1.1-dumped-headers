...
- (void)upsert:(id)arg1 cacheType:(long long)arg2 forLocation:(id)arg3 fromSources:(id)arg4 checksumList:(id)arg5 creationDate:(id)arg6 completion:(CDUnknownBlockType)arg7 enableChecksum:(_Bool)arg8;
- (void)upsert:(id)arg1 cacheType:(long long)arg2 forLocation:(id)arg3 fromSources:(id)arg4 checksumList:(id)arg5 creationDate:(id)arg6 enableChecksum:(_Bool)arg7;
