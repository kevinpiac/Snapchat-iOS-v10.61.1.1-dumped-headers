...
- (void).cxx_destruct;
- (id)initWithActionHandler:(id)arg1 discoverFeedDataFetcher:(id)arg2 storyViewModelBuilderFunc:(CDUnknownFunctionPointerType)arg3 imageDownloader:(id)arg4 videoDownloader:(id)arg5 experimentManager:(id)arg6 bitmojiAvatarId:(id)arg7 textColor:(id)arg8 backgroundColor:(id)arg9 disableWhitespaceTile:(_Bool)arg10 shouldEnablePublisherProfiles:(_Bool)arg11 shouldBounceCarousels:(_Bool)arg12 snapAdsSharedInstance:(id)arg13 gestureCoordinator:(id)arg14 streamingMediaManager:(id)arg15;
