...
@class CADisplayLink, EAGLContext, NSArray, NSMutableArray, NSMutableSet, NSString, SCThrottleTimer, SCXBlackOverlayRenderer, SCXBlockBasedCustomGLLayer, SCXDoodleSpriteRenderer, SCXHeatmapRenderer, SCXOverlaySpriteRenderer, SCXPathRenderer, SCXPluginSpriteRenderer, SCXRenderContext, SCXRenderLockManager, SCXShadedRadiusRenderer, SCXSlingshot, SCXSlingshotRenderer, SCXStandingObjectsRenderer, SCXTapAnimationViewStateManager, SCXTapCircleRenderer, SCXThumbnailViewStateManager, SCXWeather, SCXWeatherRenderer, UIView;
