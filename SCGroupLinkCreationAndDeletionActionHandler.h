...
- (void)_presentShareSheetWithDeepLinkURL:(id)arg1;
- (_Bool)handleActionWithSender:(id)arg1 actionModel:(id)arg2 fromSourceView:(id)arg3;
- (id)initWithGroupManager:(id)arg1 group:(id)arg2 experimentManager:(id)arg3 presentingViewController:(id)arg4;
