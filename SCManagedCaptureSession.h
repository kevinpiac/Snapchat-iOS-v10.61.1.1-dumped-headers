...
@class AVCaptureDepthDataOutput, AVCaptureMetadataOutput, AVCapturePhotoOutput, AVCaptureSession, AVCaptureVideoDataOutput, FBKVOController, NSString, SCCameraHealthMonitor, SCManagedCaptureDevice, SCQueuePerformer;
...
@interface SCManagedCaptureSession : NSObject <SCTraceEnabled>
{
    ...
    SCCameraHealthMonitor *_healthMonitor;
...
- (void)setBlackCameraDetector:(id)arg1 healthMonitor:(id)arg2;
...
- (void)warmupCaptureHardwareForColdAndHeadlessStartup:(unsigned long long)arg1;
