...
- (void)setDeepLinkFromCard:(_Bool)arg1 deepLinkFallBackToAppStore:(_Bool)arg2 deepLinkFallBackToWebview:(_Bool)arg3 snapIndex:(long long)arg4 interactionZoneItemIndex:(id)arg5 deepLinkUri:(id)arg6;
