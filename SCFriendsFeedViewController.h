...
@class NSArray, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, NSString, SCAddFriendsBadgedButton, SCAppNotification, SCArroyoConversationIdsManager, SCBaseMediaOperaPresenter, SCBehaviorSubject, SCCardContainerView, SCCardGradientView, SCChatMainViewController, SCCheetahTooltipManagerFeed, SCContactSyncWorkFlow, SCContextOperaPlaylistPlugin, SCDeepLinkMiniProfileController, SCDisposableObserverLifecycle, SCFeatureSettingsManager, SCFeedCellPanningState, SCFeedTableFooterView, SCFeedTableHeaderController, SCFriendLongPressGestureRecognizer, SCFriendsFeedAnimationHandler, SCFriendsFeedChatActionHandler, SCFriendsFeedQuickAddCarouselController, SCFriendsFeedQuickAddCarouselDataSource, SCFriendsFeedSnapReplayAnimationStateManager, SCFriendsFeedSubstituteAnimationStateManager, SCGrowingButton, SCLazy, SCOpenUnifiedProfileActionHandler, SCOperaPerformanceTrackingPlugin, SCOperaPlaybackIntentToNextTrackingPlugin, SCOperaPlaylistCameraPlugin, SCOperaPlaylistFeaturePlugin, SCOperaPlaylistNotificationOptInPlugin, SCOperaPresenter, SCPullToRefreshBackgroundRenderView, SCPullToRefreshView, SCQueuePerformer, SCScopedAccess, SCSnapReplayControllerV3, SCStopwatch, SCStoriesReplayManager, SCUpgradeVersionView, SCUserSession, SIGActivityIndicatorView, SIGPullToRefreshView, UIImageView, UILabel, UITableView, UITapGestureRecognizer, UIView;
@protocol NavigationDelegate, SCAddFriendsTakeoverSnapchatterDataProviding, SCFeedDataSource, SCFriendStoriesLoadingStatusHandling, SCFriendsFeedNewUserQuickAddDataSource, SCHovaOverscrollDelegate, SCNativeMessagingFeedManaging, SCOperaPlaylistFeaturePluginShouldUseExtendedResetToCamera><SCOperaPlaylistFriendStoryPluginBase, SCReplyDelegate, SCStartChatDelegate, SCSwipeViewParentDelegate;

@interface SCFriendsFeedViewController : UIViewController <SCDeepLinkableViewSource, SCUpdateListener, SCPreloadListener, SCOpenUnifiedProfileActionHandlerDelegate, SCContactSyncWorkFlowDelegate, SCTraceEnabled, UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate, SCFeedDataSourceDelegate, SCFeedTableHeaderControllerDelegate, SCFeedGestureDelegate, SKStoreProductViewControllerDelegate, SCBlockedExceptionAlertControllerDelegate, SCSnapPlayContainer, SCFeedToChatTapDetectionViewDelegate, SCPullToRefreshViewDelegate, SCCardController, SCFeedTableFooterViewDelegate, UINavigationControllerDelegate, SCBaseMediaOperaPresenterDelegate, SCFeedCellPanningStateDelegate, SCDeepLinkMiniProfileControllerDelegate, SCOperaPresenterDelegate, SCShakeToReportDelegate, SCSnapReplayControllerV3Delegate, UICollectionViewDelegate, SCFriendsFeedNewUserQuickAddDataSourceDelegate, SwipeView, SCCardStyling, SCOverscrollableController, SCFeedPage, SCS2RStackDebuggable, SCTabBarPage, SCCognacNotificationHandling>
{
    SCQueuePerformer *_performer;
    SCFriendsFeedQuickAddCarouselController *_quickAddCarouselController;
    ...
    id <SCFriendStoriesLoadingStatusHandling> _friendStoryLoadingStatusHandler;
    SCDisposableObserverLifecycle *_disposableObserverLifecycle;
    SCLazy *_incomingFriendsRepository;
    id <SCAddFriendsTakeoverSnapchatterDataProviding> _takeoverSnapchatterDataProvider;
    ...
    SCLazy *_addFriendsTakeoverForResurrectedUserGating;
...
- (id)_addFriendsTakeoverForResurrectedUserGating;
...
- (void)_didQueryFriendStoryLoadingStatusForStoryIdentifier:(id)arg1 storyType:(long long)arg2 storyLoadingStatus:(long long)arg3 playbackInfos:(id)arg4 cell:(id)arg5 cellIndexPath:(id)arg6;
...
- (void)_markPlayedAsReadWithPlayedStoriesMap:(id)arg1;
...
- (void)_presentFriendsTakeoverForSnapchatters:(id)arg1;
...
- (id)_quickAddCarouselCellWithTableView:(id)arg1;
- (void)_reloadItemsForResult:(id)arg1 viewModels:(id)arg2;
- (unsigned long long)_replyStateForCell:(id)arg1;
- (void)_resetQuickAddCarouselOffsetAndLogSeenAndAddedSuggestedSnapchatters;
