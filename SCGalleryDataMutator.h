...
@class NSString, SCMemoriesGrantSavedSnapRequester, SCQueuePerformer, SCUserSession;
...
- (void)appendToDayStory:(id)arg1 snapPlaceholders:(id)arg2 userContext:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)replacePhoto:(id)arg1 cloudFile:(id)arg2 entry:(id)arg3 duration:(double)arg4 isInfiniteDuration:(_Bool)arg5 overlayFormat:(id)arg6 overlay:(id)arg7 userContext:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;
