...
@class FriendStoriesCollection, NSArray, NSDictionary, NSMutableSet, NSString, SCBusinessStories, SCGroupStoryCollection, SCLazy, SCLiveStoriesSubmissionsCollection, SCMyContributionStoriesCollection, SCMyStories, SCQueuePerformer, SCStoriesModelUpdateListenerAnnouncer, SCStoryMediaCache, SCTemporaryDatastore;

@interface SCStories : NSObject <SCTraceEnabled, SCStoryMediaStateListener, SCNetworkConnectivityListener, SCNetworkActivityListener, NSCoding>
{
...
- (void)_updateOnMainThreadWithMyStories:(id)arg1 myContributionStories:(id)arg2 groupStories:(id)arg3 myGroupStories:(id)arg4 friendStories:(id)arg5 idMapping:(id)arg6 storiesResponse:(id)arg7 requestMetadata:(id)arg8 triggerType:(long long)arg9 completion:(CDUnknownBlockType)arg10;
...
- (void)insertPostingContributionStory:(id)arg1 contributionStoryType:(long long)arg2 allowRevertFromPostedToPending:(_Bool)arg3;
