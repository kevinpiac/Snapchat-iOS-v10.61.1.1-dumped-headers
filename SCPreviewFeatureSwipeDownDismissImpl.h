...
@class NSString, SCPreviewConfiguration, SCPreviewView, UIPanGestureRecognizer, UIViewController;
...
- (void)animatorWillFinishTransition:(id)arg1;
- (void)animatorWillStartTransition:(id)arg1;
