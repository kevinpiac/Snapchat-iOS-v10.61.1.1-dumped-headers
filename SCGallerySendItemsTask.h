...
@interface SCGallerySendItemsTask : NSObject
{
...
- (void)_postOneStory:(id)arg1 creationDate:(id)arg2 isFromCameraRoll:(_Bool)arg3 creatorAttribution:(id)arg4;
...
- (id)initWithSendableMediaGroups:(id)arg1 cloudFiles:(id)arg2 sendItemsCounter:(id)arg3 smartSharedMediaIds:(id)arg4 smartSharingFailures:(id)arg5 shouldShowToast:(_Bool)arg6 userContext:(id)arg7 userSession:(id)arg8 arroyoMediaMessageSender:(id)arg9 arroyoGroupFilterer:(id)arg10;
@property(readonly, copy, nonatomic) NSArray *mediaGroups; // @synthesize mediaGroups=_mediaGroups;
- (void)sendSnapUsingChatV3:(id)arg1 captureDate:(id)arg2 isFromCameraRoll:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
