...
@class NSAttributedString, NSMutableDictionary, NSString, SCCaptionControlledView, SCDynamicCaptionStyle, SCExperimentManager, SCPreviewCaptionTextView, UIColor, UIView;
