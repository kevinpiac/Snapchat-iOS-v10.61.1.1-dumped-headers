...
@class NSArray, NSString, NSURL, SCSpectaclesFirmwareVersion;
...
@property(readonly, nonatomic) SCSpectaclesFirmwareVersion *applicableFirmwareVersion; // @synthesize applicableFirmwareVersion=_applicableFirmwareVersion;
