...
- (void)logDiscoverTopSnapSnapViewWithFullView:(_Bool)arg1 mediaDisplayTimeSec:(double)arg2 durationSec:(double)arg3 mediaType:(long long)arg4;
- (void)logEditionViewWithRequestManager:(id)arg1;
- (void)logFinishPlaybackIntentToNextForChunk:(id)arg1 abandoned:(_Bool)arg2 isStreaming:(_Bool)arg3 videoStartPreparingTimeMs:(double)arg4 videoPrepareTimeMs:(double)arg5;
