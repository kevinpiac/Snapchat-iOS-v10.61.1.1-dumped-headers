...
@interface SCImageProcessLookupTableDistortionRGBCommand : SCImageProcessCommand
{
...
- (void).cxx_destruct;
- (unsigned int)_createLookupTextureWithData:(const void *)arg1 pixelWidth:(unsigned int)arg2 pixelHeight:(unsigned int)arg3 textureUnit:(unsigned int)arg4;
- (id)initWithLookupTable:(id)arg1 size:(struct CGSize)arg2;
