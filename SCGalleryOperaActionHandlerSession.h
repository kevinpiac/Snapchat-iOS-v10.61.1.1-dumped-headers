...
@class NSDictionary, NSString, SCGalleryActivityController, SCGalleryOperaConfiguration, SCGalleryPreviewController, SCGalleryPrivateGallerySetupFlow, SCGallerySendController, SCOperaEventListenerAnnouncer, SCOperaViewController, SCUserSession;
...
- (void)_handlRemoveSnapFromStoryAction:(unsigned long long)arg1 entry:(id)arg2 snap:(id)arg3;
