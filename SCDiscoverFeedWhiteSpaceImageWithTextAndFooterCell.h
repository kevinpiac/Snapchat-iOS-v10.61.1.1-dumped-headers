...
@class NSString, SCDiscoverFeedCollectionViewCellTapHandler, SCDiscoverFeedWhiteSpaceHeadlineView, SCDiscoverFeedWhiteSpaceImageWithTextView, SCDiscoverFeedWhiteSpaceProfileRowView, SCEventListenerAnnouncer, SCLazy, UIView;
@protocol SCActionHandling, SCDiscoverFeedWhiteSpaceGestureCoordinating, SCImageDownloading;

@interface SCDiscoverFeedWhiteSpaceImageWithTextAndFooterCell : SCSearchCollectionViewCell <UIGestureRecognizerDelegate, SCEventAnnouncing, SCEventListener, SCViewModelConfigurable, SCActionable, SCViewportConfigurable, SCDiscoverFeedStoryTileWithCoverImageConfigurable, SCDiscoverFeedCollectionViewCellAnimating, SCDiscoverFeedTileOperaBaseViewProviding, SCDiscoverFeedWhiteSpaceTileGestureHandling>
{
