...
- (id)initWithCapturer:(id)arg1 userSession:(id)arg2 datastore:(id)arg3 cameraViewType:(long long)arg4 logger:(id)arg5 coreCameraLogger:(id)arg6 hapticsManager:(id)arg7 audioSession:(id)arg8 ticketCreator:(id)arg9 handsFree:(id)arg10 multiSnap:(id)arg11 batchCapture:(id)arg12 videoCaptureLogger:(id)arg13;
