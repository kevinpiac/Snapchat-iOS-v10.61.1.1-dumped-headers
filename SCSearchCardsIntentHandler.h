...
@class NSArray, NSDictionary, NSString, SCCognacOperaPresenter, SCCommerceOperaPresenter, SCDiscoverFeedStoriesEverywhereService, SCEventListenerAnnouncer, SCLazy, SCMiniProfileActionHandler, SCMiniProfileViewController, SCOperaPlaylistEditionsPlugin, SCOperaPresenter, SCScopedAccess, SCSearchCachedRequestManager, SCSearchModerationHandler, SCSearchNavigationCoordinator, SCSearchReplyCameraPresenter, SCSearchSession, SCSearchStorySharePopupPresenter, SCSearchStoryShareSession, SCUnifiedProfilePresenter, UINavigationController, UIViewController;
@protocol NavigationDelegate, SCReplyDelegate, SCSearchCameraDismissing, SCSearchCardsIntentHandlerDelegate, SCSearchIntent, SCSearchResultsViewControllerDelegate, SCStartChatDelegate;

@interface SCSearchCardsIntentHandler : NSObject <SCBrowserViewControllerDelegate, MFMessageComposeViewControllerDelegate, SCSearchModalPresenting, SCStartChatDelegate, SCReplyDelegate, SCSearchStoryShareSessionDelegate, SCSearchStorySharePopupPresenterDelegate, SCSearchStoriesPresenterDelegate, SCEventListener, UIViewControllerTransitioningDelegate, SCSearchModerationHandlerDelegate, SCSearchDiscoverStoriesPresenterDelegate, SCMiniProfileViewControllerDelegate, SCGroupMiniProfileViewControllerDelegate, SCSearchMomentsOperaPresenterDelegate, SCStoryMiniProfileViewControllerDelegate, SCFriendUnifiedProfileActionHandlerDelegate, SCGroupUnifiedProfileActionHandlerDelegate, SCUnifiedProfilePresenterDelegate, SCCommerceOperaPresenterDelegate, SCCognacOperaPresenterDelegate, SCSearchIntentHandler>
{
