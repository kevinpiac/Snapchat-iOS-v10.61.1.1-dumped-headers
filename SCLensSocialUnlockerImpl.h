...
- (void)_requestDidSucceed:(id)arg1 withResponse:(id)arg2 data:(id)arg3 shouldAddToUnlockStore:(_Bool)arg4 completion:(CDUnknownBlockType)arg5 callbackQueue:(id)arg6;
