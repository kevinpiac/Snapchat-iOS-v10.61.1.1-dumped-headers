...
- (id)fetchContentWithLensResource:(id)arg1 lensID:(id)arg2 cacheDomain:(id)arg3 requestSettings:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (id)initWithRequestManager:(id)arg1 preferencesStorage:(id)arg2 downloadTracker:(id)arg3 archiveConverter:(id)arg4 signatureValidator:(id)arg5;
