...
@class NSString, NSURL, SCCognacIAPMockDataStorage, SCQueuePerformer, SCSessionRequestManager, SCSnapTokenManager;
...
@interface SCCognacServiceClient : NSObject <SCSearchV2CognacTokenProviding, SCCognacAppInstanceAuthTokenProviding>
{
    ...
    SCCognacIAPMockDataStorage *_cognacIAPMockDataStorage;
...
- (void)submitLeaderboardScoreWithLeaderboardId:(id)arg1 score:(long long)arg2 completionQueue:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
