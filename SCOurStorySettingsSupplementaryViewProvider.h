...
@class NSDictionary, NSString, SCOurStorySettingsHeaderView;
@protocol SCCollectionViewSectionSupplementaryViewProviderDelegate;

@interface SCOurStorySettingsSupplementaryViewProvider : NSObject <SCCollectionViewSectionSupplementaryViewProviding, SCCollectionViewSupplementaryViewModelsConfigurable>
{
