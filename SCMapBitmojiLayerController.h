...
@protocol SCMapBitmojiLayerControllerDelegate, SCMapPeopleFriendsProvider, SCMapPersonLocationStringsProvider, SCMapPersonLocationsProviding, SCMapStatusViewedStateFetching;
