...
@interface SCGroupStorySelectMembersViewController : UIViewController <SCSearchQueryResultControllerDelegate, FriendsTableIndexDelegate, SCSendConfirmationViewControllerDelegate, SCSendToDismissTransitionControllerDelegate, SCUserSelectionListener, UIGestureRecognizerDelegate, UICollectionViewDelegate, SCSearchContentViewControlling>
{
