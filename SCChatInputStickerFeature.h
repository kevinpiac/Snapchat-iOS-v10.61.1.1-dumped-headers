...
- (id)initWithUserSession:(id)arg1 stickerFavoritesDelegate:(id)arg2 sender:(id)arg3 bitmojiAvatarBuilderRouterDelegate:(id)arg4 stickerAccessoryDelegate:(id)arg5;
