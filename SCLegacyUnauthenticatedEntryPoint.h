...
@class SCApplicationStorageServices, SCDeviceCheckServices, SCIdentityLoggerServices, SCLegacyUnauthenticatedWorkflow, SCRegistrationDeviceInfoServices, SCScopeExposer, SCSystemScope, SCUnauthenticatedScope;
