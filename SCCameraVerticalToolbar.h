...
@class NSMutableArray, NSMutableDictionary, NSString, SCCameraOverlayView, SCCameraToolbarBackgroundView, SCCameraToolbarButton, SCCameraToolbarView, SCCameraVerticalToolbarSplitter, SCDisposableObserverLifecycle, SCFeatureReference, SCNavigationBarButtonItem, UIView;
...
@interface SCCameraVerticalToolbar : SCFeature <SCManagedCapturerListener, SCCameraToolbarButtonDelegate, SCFeatureCameraToolbar, SCCameraGestureResponder, SCCaptureWorkflowTransitionAnimatableFeature>
{
    ...
    SCCameraToolbarBackgroundView *_toolbarBackgroundView;
...
- (void)_updateBottomBarSplitterAlpha;
- (void)_updateCollapseButton;
- (void)_updateCollapseButtonAlpha;
- (void)_updateExpandAndCollapseButton;
- (void)_updateExpandButton;
- (void)_updateExpandButtonAlpha;
...
- (id)initWithCapturer:(id)arg1 features:(id)arg2 applicationLifecycleEvents:(id)arg3 viewControllerLifecycleEvents:(id)arg4 mainCameraViewControllerLifecycleEvents:(id)arg5 cameraViewType:(long long)arg6 cameraUserActionLogger:(id)arg7;
