...
- (_Bool)composer_setOverflow:(id)arg1 animator:(id)arg2;
- (_Bool)composer_setRasterize:(_Bool)arg1;
- (_Bool)composer_setTouchAreaExtensionValue:(id)arg1;
- (void)composer_setTouchGestureRecognizerForTouchType:(unsigned long long)arg1 action:(id)arg2;
...
- (void)composer_setupGestureRecognizerForClass:(Class)arg1 action:(id)arg2 predicate:(id)arg3;
