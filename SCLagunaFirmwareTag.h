...
@property(retain, nonatomic) SCSpectaclesFirmwareVersion *latestVersion; // @synthesize latestVersion=_latestVersion;
@property(retain, nonatomic) SCSpectaclesFirmwareVersion *minimumAcceptedVersion; // @synthesize minimumAcceptedVersion=_minimumAcceptedVersion;
