...
@protocol SCFriendStoriesLoadingStatusHandling;
...
- (id)initWithPerformer:(id)arg1 currentUsername:(id)arg2 currentUserId:(id)arg3 currentUserBirthday:(id)arg4 storiesReplayManager:(id)arg5 substituteAnimationStateManager:(id)arg6 friendmojiPresenter:(id)arg7 replayAnimationStateManager:(id)arg8 storyLoadingStatusHandler:(id)arg9 mapExploreDataStore:(id)arg10 experimentManager:(id)arg11 arroyoConversationIdsManager:(id)arg12 groupInvitesStore:(id)arg13 tooltipManager:(id)arg14;
