...
@class NSString, SCAddFriendsQuickAddCarouselSectionDataProvider, SCAddFriendsQuickAddCarouselUpdateDecider, SCExperimentManager, SCLazy, SCSessionRequestManager;
...
@interface SCDiscoverFeedQuickAddCarouselSectionCreator : NSObject <SCDiscoverFeedLocalSectionDescriptorProviding, SCDiscoverFeedCollectionViewSectionCreating>
{
    ...
    SCAddFriendsQuickAddCarouselSectionDataProvider *_dataProvider;
