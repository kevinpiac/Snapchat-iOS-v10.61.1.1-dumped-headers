...
@interface SCDiscoverChannel : NSObject <NSCoding, SCAdOwnerProtocol, SCMediaOwnerProtocol, SCPublicContentMiniProfileDataEntry, SCFilterableProtocol, SCSubscribableContent>
{
    _Bool _isShow;
    _Bool _isNews;
