...
- (void)_applyBestFriendsNotificationSoundIfNecessaryAndAddNotification:(id)arg1 completion:(CDUnknownBlockType)arg2 systemCompletion:(id)arg3;
...
- (id)initWithNotificationManager:(id)arg1 conversationManager:(id)arg2 conversationStore:(id)arg3 snapLogger:(id)arg4 fideliusManager:(id)arg5 mediaRequestManager:(id)arg6 mediaPrefetcher:(id)arg7 messageActionHandler:(id)arg8 messageReceiver:(id)arg9 snapchattersDataFetcher:(id)arg10 userSession:(id)arg11;
