...
- (NSString *)generateNewTokenWithLabel:(NSString *)arg1;
...
- (void)updateToken:(NSString *)arg1 configuration:(void (^)(SCAudioSessionConfigurationMaker *))arg2 callbackPerformer:(id <SCPerforming>)arg3 callback:(void (^)(NSError *))arg4;
@end
