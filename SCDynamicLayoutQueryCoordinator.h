...
@class NSMutableArray, NSMutableSet, NSString, SCDiscoverFeedDebugInfoDataProvider, SCDiscoverFeedInteractionHistoryManager, SCDiscoverFeedInteractionHistoryModifier, SCDiscoverFeedTapHistoryManager, SCImpalaWatchedStateManager, SCQueuePerformer, SCSSMAdsClientInfo, SCScopedAccess, SCSearchNavigationCoordinator, SCSearchQuery, SCSessionRequestManager, SCSnapTokenManager, SCUserSession;
@protocol SCDiscoverFeedDataFetching, SCDiscoverFeedDataMutating, SCDiscoverFeedEventsSessionProviding, SCDiscoverFeedQueryCoordinatingDelegate, SCDynamicLayoutUIBuilding;
...
@interface SCDynamicLayoutQueryCoordinator : NSObject <SCDiscoverFeedQueryCoordinating>
{
    ...
    NSMutableSet *_prefetchedFeedTypes;
    _Bool _isLoading;
...
- (void)_fetchRemoteDFStoriesIfNeeded:(id)arg1 updatingBlock:(CDUnknownBlockType)arg2;
...
- (id)_getUpdatedPrefetchQuery:(id)arg1;
...
- (void)_validateHasPivotCache:(_Bool)arg1 needRefresh:(_Bool)arg2;
...
- (id)initWithUserSession:(id)arg1 discoverFeedDataFetcher:(id)arg2 discoverFeedDataMutator:(id)arg3 eventsSessionProvider:(id)arg4 adsClientInfo:(id)arg5 dynamicLayoutUIBuilder:(id)arg6 disableWhitespaceTile:(_Bool)arg7;
