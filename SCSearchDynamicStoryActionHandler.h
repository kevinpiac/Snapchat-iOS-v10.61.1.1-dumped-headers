...
@class NSDictionary, NSString, SCDiscoverFeedStoriesEverywhereService, SCEventListenerAnnouncer, SCMiniProfileActionHandler, SCSearchModerationHandler, SCSearchNavigationCoordinator, SCSearchStoriesPresenter, SCSearchStoryDebugController, SCSearchStorySharePopupPresenter, SCSearchStoryShareSession, SCUserSession, UIViewController;
@protocol NavigationDelegate, SCSearchCameraDismissing;

@interface SCSearchDynamicStoryActionHandler : NSObject <SCSearchStoriesPresenterDelegate, SCSearchStorySharePopupPresenterDelegate, SCSearchStoryShareSessionDelegate, SCSearchStoryDebugControllerDelegate, SCSearchModerationHandlerDelegate, SCEventListener, SCStoryMiniProfileViewControllerDelegate, SCActionHandling, SCEventAnnouncing>
{
