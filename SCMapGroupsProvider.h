...
@class NSString, SCExperimentManager, SCLazy, SCMapPeopleGroupsListenerAnnouncer, SCStories;
...
- (id)initWithCurrentUserId:(id)arg1 currentUsername:(id)arg2 groupsDataFetcher:(id)arg3 groupsDataTracker:(id)arg4 stories:(id)arg5 experimentManager:(id)arg6;
