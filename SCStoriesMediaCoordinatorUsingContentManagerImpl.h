...
- (void)_deleteMedias:(id)arg1;
- (void)_fetchMedia:(id)arg1 userInitiated:(_Bool)arg2 completePrefetch:(_Bool)arg3 contexts:(id)arg4 batchId:(id)arg5;
...
- (void)_releaseLocalAuthoritativeContentForCacheKeys:(id)arg1;
...
- (void)saveLocalContent:(id)arg1 decryptedMedia:(id)arg2 shouldGenerateThumbnails:(_Bool)arg3;
