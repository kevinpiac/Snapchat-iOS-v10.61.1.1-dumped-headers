...
- (void)insertUnlockables:(id)arg1 forLocation:(id)arg2 fromSources:(id)arg3 checksumList:(id)arg4 creationDate:(id)arg5 completion:(CDUnknownBlockType)arg6 enableChecksum:(_Bool)arg7;
