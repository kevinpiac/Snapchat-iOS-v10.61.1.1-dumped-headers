...
#import "SCNewGroupActionHandlerStateTransitionDelegate-Protocol.h"
...
@class NSArray, NSDictionary, NSMutableSet, NSString, SCChatViewHeader, SCFriendsTableIndex, SCInvalidFriendAlertView, SCLazy, SCLeftSwipeableTransitionProvider, SCMaxGroupSizeAlertView, SCNewGroupConfiguration, SCNewGroupView, SCRecipientBar, SCRegisterV2EnterButton, SCSearchQueryResultController, SCSendToDocObjectRecipientDataSource, SCSendToNewGroupDataRepository, SCSendToSelectionStateManager, SCTooSmallGroupSizeAlertView, SCUnifiedProfileNewGroupChatInputBarView, UIView;
@protocol SCActionHandling, SCNewGroupViewControllerDelegate;

@interface SCNewGroupViewController : UIViewController <FriendsTableIndexDelegate, SCSearchQueryResultControllerDelegate, UICollectionViewDelegate, SCShakeToReportDelegate, SCRecipientBarDelegate, SCHeaderDelegate, SCChatViewHeaderDataSource, SCUserSelectionListener, SCInvalidFriendAlertViewDelegate, SCUnifiedProfileNewGroupChatInputBarActionHandling, SCUnifiedProfileNewGroupChatInputBarDelegate, SCSnapchattersDataRequestListener, SCNewGroupActionHandlerStateTransitionDelegate, SCLeftSwipeableDismissTransitionControllerDelegate, SwipeView>
{
    ...
    id <SCNewGroupViewControllerDelegate> _dismissDelegate;
...
- (long long)_friendsSectionStartIndex;
...
- (void)dismiss;
@property(nonatomic) __weak id <SCNewGroupViewControllerDelegate> dismissDelegate; // @synthesize dismissDelegate=_dismissDelegate;
