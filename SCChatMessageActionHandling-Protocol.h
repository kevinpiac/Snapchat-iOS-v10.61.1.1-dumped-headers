...
- (void)conversationId:(NSString *)arg1 openSnap:(NSString *)arg2 stackId:(NSString *)arg3 isFirstSnapInStack:(_Bool)arg4 atTime:(NSDate *)arg5 registerBlock:(void (^)(SCChatMessageV3 *))arg6;
...
- (void)sendLegacyPresencesForConversationId:(NSString *)arg1 legacyPresences:(NSDictionary *)arg2 extendedPresences:(NSDictionary *)arg3 presencesMetadata:(NSDictionary *)arg4 toRecipients:(NSArray *)arg5;
