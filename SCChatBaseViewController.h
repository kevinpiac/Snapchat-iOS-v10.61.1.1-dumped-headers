...
@class NSMutableDictionary, NSNotificationCenter, NSString, SCActionMenuShareController, SCAppNotification, SCChatCardAnimationContainerView, SCChatContainerView, SCChatHamburgerAnimator, SCChatInputViewController, SCChatViewHeader, SCChatViewLifeCycleListenerAnnouncer, SCChatViewLogger, SCCognacAppActiveCardController, SCCognacAppLauncherModalTableSection, SCCognacChatDockDataProvider, SCCognacChatDockViewController, SCCognacChatDrawerCollectionViewSectionDataProvider, SCCognacChatDrawerViewController, SCCognacOperaPresenter, SCLazy, SCModalHamburgerRootViewController, SCTV3TableContentInsetUpdater, UIView;
@protocol NavigationDelegate, SCCardAnimationViewProtocol, SCChatViewControllerParentDelegate, SCReplyDelegate, SCStackChatsDelegate, SCStartChatDelegate, SCTalkClientController;

@interface SCChatBaseViewController : UIViewController <SCCognacOperaPresenterDelegate, SCCognacAppActiveCardControllerDelegate, SCCognacChatDockAppPresenting, SCCognacChatDockViewControllerDelegate, SCTraceEnabled, SCChatCellParentViewControllerDelegate, SCChatUIProvider, SCSharedStoryPresenterDelegate, SCChatSideMenuLifeCycleListener, SCSharedStoryMiniProfilePresenterDelegate, SCSearchStoriesPresenterDelegate, SCChatURLMediaOperaPresenterDelegate, SCTV3ClientDependenciesProvider, UIViewControllerTransitioningDelegate, SCChatVisibilityProvider, SCChatHamburgerTableSectionOneOnOneSettingDelegate, SCEventListener, SCTPresencePillTapListener, SCUnifiedProfileViewControllerLifecycleListener, SCUpdateListener, SCBaseMediaOperaPresenterDelegate, SCTableControllerInsetUpdater, SCContextOperaPlaylistPluginDelegate, SCActionSheetDelegate, SCHamburgerAnimationDelegte, SCCognacNotificationHandling>
{
    ...
    SCModalHamburgerRootViewController *_modalAppLauncherViewController;
    SCCognacOperaPresenter *_cognacOperaPresenter;
    SCCognacAppLauncherModalTableSection *_appLauncherTableSection;
    NSString *_currentPuppyProjectId;
    NSMutableDictionary *_projectIdToBuildModels;
...
@property(retain, nonatomic) SCCognacAppLauncherModalTableSection *appLauncherTableSection; // @synthesize appLauncherTableSection=_appLauncherTableSection;
...
- (void)clearPuppyBuilds;
- (void)clearPuppyBuildsIfNecessary;
...
- (id)conversationId;
@property(copy, nonatomic) NSString *currentPuppyProjectId; // @synthesize currentPuppyProjectId=_currentPuppyProjectId;
...
- (void)loadView;
@property(retain, nonatomic) SCModalHamburgerRootViewController *modalAppLauncherViewController; // @synthesize modalAppLauncherViewController=_modalAppLauncherViewController;
...
@property(retain, nonatomic) NSMutableDictionary *projectIdToBuildModels; // @synthesize projectIdToBuildModels=_projectIdToBuildModels;
- (void)releaseMemory;
