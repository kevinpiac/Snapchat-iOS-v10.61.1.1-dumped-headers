...
@class CLLocation, NSSet, NSString, SCEmbeddedMapGiveAccessErrorView, SCEmbeddedMapViewLoggingSession, SCEmbeddedMapViewOptions, SCExperimentManager, SCFeatureSettingsManager, SCLocationSharingPreferencesV1, SCMapBasePersonLocationsProvider, SCMapBitmojiLayerController, SCMapDefaultPersonLocationStringsProvider, SCMapFilteredPersonLocationClustersProvider, SCMapLoadingTracker, SCMapPinSpriteManager, SCMapServerService, SCMapSnapTokenService, SCMapTimeAndWeatherController, SCMapTimeAndWeatherView, SCMapZoomAwarePersonLocationClustersProvider, SCXBitmojiLayer, SCXRenderLayer, SCXRenderLayerOptions;
@protocol SCDownloadableContentManaging, SCEmbeddedMapViewDelegate, SCLocationProvider, SCMapConfiguration, SCMapCustomGLRenderer, SCMapGestures, SCMapInstance, SCMapLoadingState, SCMapPeopleFriendsProvider, SCMapPeopleGroupsProvider, SCMapStatusViewedStateFetching, SCMapViewport, SCMapViewportMetadataProvider, SCXBitmojiAvatarGeneratorProtocol, SCXGameStateProvider;

@interface SCEmbeddedMapView : UIView <SCMapLoadingStateListener, SCXRenderLayerDelegate, SCMapLoadingTrackerDelegate, SCLocationPermissionObserver, SCLocationSharingPreferencesListener, SCMapPersonLocationsListener>
{
    ...
    id <SCMapStatusViewedStateFetching> _statusViewedStateProvider;
...
- (id)initWithFrame:(struct CGRect)arg1 currentUserId:(id)arg2 downloadableContentManager:(id)arg3 experimentManager:(id)arg4 featureSettingsManager:(id)arg5 locationProvider:(id)arg6 locationSharingPreferences:(id)arg7 loggingSession:(id)arg8 mapBasePersonLocationsProvider:(id)arg9 mapBitmojiAvatarGenerator:(id)arg10 mapGameStateProvider:(id)arg11 mapInstanceProvider:(id)arg12 mapPeopleFriendsProvider:(id)arg13 mapPeopleGroupsProvider:(id)arg14 mapServerService:(id)arg15 mapSnapTokenService:(id)arg16 renderLayerOptions:(id)arg17 statusViewedStateProvider:(id)arg18;
