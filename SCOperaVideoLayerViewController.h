...
@class AVAsset, AVPlayer, AVPlayerItemTrack, CALayer, CAShapeLayer, FBKVOController, NSError, NSNotificationCenter, NSString, NSTimer, SCAVPlayerVolumeController, SCAudioStitchPlaybackHandler, SCOperaCommentContainerView, SCOperaVideoLayerView, SCOperaVideoStallTracker, SCStopwatch, UIGestureRecognizer, UIVisualEffectView;
...
- (void)_setupVideoProgressTimerIfNecessary;
