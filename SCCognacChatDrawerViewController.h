...
- (void)cognacChatDrawerCollectionViewSectionActionHandler:(id)arg1 didLaunchAppInstanceStartWithAppId:(id)arg2 conversationId:(id)arg3;
...
- (void)cognacChatDrawerCollectionViewSectionActionHandler:(id)arg1 openAppInstanceWithAppId:(id)arg2 conversationId:(id)arg3;
