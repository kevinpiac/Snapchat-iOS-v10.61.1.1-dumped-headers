...
- (id)initWithUserSession:(id)arg1 storiesPlaybackDataProvider:(id)arg2 storiesMediaCoordinator:(id)arg3 replyDelegate:(id)arg4 startChatDelegate:(id)arg5 navigationDelegate:(id)arg6 storySessionId:(long long)arg7 playbackConfig:(id)arg8 operaPageProviderSubject:(id)arg9;
