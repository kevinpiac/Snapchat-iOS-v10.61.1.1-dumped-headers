...
@class LSARemoteAssetsComponent, NSMutableDictionary, NSString, SCAssetValidator, SCLens;
@protocol SCLensDataFetcher, SCLensLoggerConsumptionTrackingProviding, SCLensRemoteAssetsUploader, SCPerforming;
...
- (id)initWithRemoteAssetsComponent:(id)arg1 dataFetcher:(id)arg2 assetsUploader:(id)arg3 consumptionLensLogger:(id)arg4;
- (id)initWithRemoteAssetsComponent:(id)arg1 dataFetcher:(id)arg2 assetsUploader:(id)arg3 consumptionLensLogger:(id)arg4 performer:(id)arg5;
