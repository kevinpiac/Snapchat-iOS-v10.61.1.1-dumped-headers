...
+ (double)croppingAspectRatioWithCroppingState:(id)arg1 captionState:(id)arg2 stickerStates:(id)arg3 drawingMetadata:(id)arg4 geoFilterSelected:(_Bool)arg5 interfaceOrientationIsPortrait:(_Bool)arg6;
