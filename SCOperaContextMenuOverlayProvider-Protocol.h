...
@protocol SCOperaContextMenuController, SCSizeChangeAnnouncingView;
...
- (id <SCOperaContextMenuController>)contextMenuControllerWithLayerViewController:(SCOperaContextMenuLayerViewController *)arg1;
