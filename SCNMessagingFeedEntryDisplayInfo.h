...
+ (id)FeedEntryDisplayInfoWithDisplayTimestamp:(long long)arg1 lastUpdateActorUserIds:(id)arg2 feedItemCreatorId:(id)arg3 feedItem:(id)arg4;
- (void).cxx_destruct;
- (id)description;
...
- (id)initWithDisplayTimestamp:(long long)arg1 lastUpdateActorUserIds:(id)arg2 feedItemCreatorId:(id)arg3 feedItem:(id)arg4;
