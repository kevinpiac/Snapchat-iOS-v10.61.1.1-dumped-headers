...
@interface SCFriendsFeedArroyoDataCoordinator : NSObject <SCTraceEnabled, SCFriendsFeedArroyoDataCoordinating, SCArroyoConversationDataUpdateListener>
{
    ...
    NSMutableDictionary *_activeMessageDataObservationTokens;
...
- (id)_fetchAndObserveActiveMessageDataWithFeedIds:(id)arg1;
...
- (void)_syncFeed;
- (void)_updateActiveMessageDataWithFetchedResult:(id)arg1 feedId:(id)arg2;
