...
@class NSString, SCGalleryEntrySyncStatusGenerator, SCGallerySnapCellViewModel, SCLoadingIndicatorView, SCMemoriesStatusIcon, SCUserSession, UIImage, UIImageView, UILabel, UIView;
@protocol SCCachingMediaRequest, SCCanceling, SCGallerySnapCellDelegate;

@interface SCGallerySnapCell : UICollectionViewCell <SCGalleryEntrySyncStatusGeneratorDelegate, IGListBindable, SCGalleryCellTransitioning, SCGalleryViewCellSelecting>
{
