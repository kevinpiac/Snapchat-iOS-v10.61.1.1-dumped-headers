...
- (void)_logBrowseSnapViewWithSnap:(id)arg1 snapOverlay:(id)arg2 playerVersion:(long long)arg3 pinchToZoomMillis:(double)arg4 maxRotationDegree:(double)arg5 minRotationDegree:(double)arg6;
...
- (void)_logSpectaclesCustomExportWithContentId:(id)arg1 activityItemProvider:(id)arg2 contextMenuSource:(long long)arg3 shareChannel:(id)arg4;
...
- (void)operaPlaybackIntentToNextForSnap:(id)arg1 loadingLatencyInSec:(double)arg2 isFirstDisplayedSnap:(_Bool)arg3 mediaDidLoad:(_Bool)arg4 requireNetworkDownload:(_Bool)arg5 isStreaming:(_Bool)arg6;
