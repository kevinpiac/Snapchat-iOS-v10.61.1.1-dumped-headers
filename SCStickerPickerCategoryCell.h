...
- (id)_groupedStickerCategoryFromUnfiltered:(id)arg1 orientation:(long long)arg2;
...
- (double)heightForToggleableUIForCollectionView:(id)arg1 layout:(id)arg2;
...
- (void)setStickerCategory:(id)arg1 superCategoryType:(long long)arg2 orientation:(long long)arg3 userSession:(id)arg4 queryKeywords:(id)arg5 enableWhiteUI:(_Bool)arg6 portraitColumnCount:(long long)arg7 landscapeColumnCount:(long long)arg8 expandablePackUIEnabled:(_Bool)arg9;
