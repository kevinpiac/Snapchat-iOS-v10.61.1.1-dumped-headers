...
@class NSData, NSDate, NSSet, NSString, SCChatMediaContent;
...
- (void)retrieveContentAndOverlayForUnZippedMedia:(SCChatMediaContent *)arg1 completionBlock:(void (^)(NSDictionary *, _Bool))arg2;
- (void)retrieveContentForDedupeKey:(NSString *)arg1 completion:(void (^)(NSData *, _Bool))arg2;
- (void)retrieveZipSubContentsAndThumbnailForMedia:(SCChatMediaContent *)arg1 completionBlock:(void (^)(NSDictionary *, NSData *, NSDictionary *, long long))arg2;
