...
@class NSArray, NSString, SCContextSession, SCEventListenerAnnouncer, SCOperaPresenter, SCOperaViewInteraction, SCSearchDynamicStory, SCUpdateListenerAnnouncer, SCUserSession, SCViewControllerTransitionAnimator, UIView;
...
- (void)presentFriendStoriesList:(id)arg1 startIndex:(long long)arg2 fromBaseView:(id)arg3 isCircleTransition:(_Bool)arg4 viewLocation:(unsigned long long)arg5;
