...
- (id)initWithStickerId:(id)arg1 stickerType:(id)arg2 mediaPath:(id)arg3 priority:(id)arg4 active:(id)arg5 hasAlpha:(id)arg6 capabilities:(id)arg7 isAnimated:(id)arg8 uniqueId:(id)arg9 order:(id)arg10 contentObject:(id)arg11;
