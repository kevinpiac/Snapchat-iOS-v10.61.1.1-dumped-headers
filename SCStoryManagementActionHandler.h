...
@protocol NavigationDelegate, SCNotificationManager, SCReplyDelegate, SCStartChatDelegate, SCStoriesMediaCoordinating, SCStoriesPlaybackDataProviding, SCStoryManagementActionHandlerDelegate;
...
- (id)initWithUserSession:(id)arg1 myStories:(id)arg2 storiesPlaybackDataProvider:(id)arg3 storiesMediaCoordinator:(id)arg4 replyDelegate:(id)arg5 startChatDelegate:(id)arg6 notificationManager:(id)arg7 navigationDelegate:(id)arg8;
