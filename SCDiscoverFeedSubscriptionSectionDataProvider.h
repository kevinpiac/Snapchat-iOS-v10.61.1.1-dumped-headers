...
@protocol NSCopying, SCDiscoverFeedSectionCollapseCoordinating, SCDiscoverFeedSnapAdsSharedInstanceStud, SCDiscoverFeedWhiteSpaceGestureCoordinating, SCPerforming, SCSectionDataProvidingDelegate;
...
- (id)initWithUserSession:(id)arg1 storiesDataStore:(id)arg2 layoutType:(long long)arg3 sectionViewAllButtonStates:(id)arg4 collapseCoordinator:(id)arg5 gestureCoordinator:(id)arg6 snapAdsSharedInstance:(id)arg7;
