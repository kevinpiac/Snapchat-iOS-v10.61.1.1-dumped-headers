...
@protocol SCImageProcessGLWrapper, SCImageProcessOutputImageBaking;
...
- (void)cancel;
- (id)initWithGlWrapper:(id)arg1 imageData:(id)arg2 histogramData:(id)arg3 pixelSize:(CDStruct_5e758c1a)arg4 preCommands:(id)arg5 commands:(id)arg6 colorFilterSessionCompletionHandler:(CDUnknownBlockType)arg7 outputImageBaker:(id)arg8 renderer:(id)arg9 orientation:(long long)arg10 viewportTranform:(struct CGAffineTransform)arg11 displayTimestamp:(double)arg12 backgroundColor:(id)arg13 completionHandler:(CDUnknownBlockType)arg14 colorFilterSessionId:(id)arg15;
