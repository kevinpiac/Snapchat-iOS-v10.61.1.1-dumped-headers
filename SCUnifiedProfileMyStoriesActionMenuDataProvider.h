...
@interface SCUnifiedProfileMyStoriesActionMenuDataProvider : NSObject <SCUpdateListener, SCUnifiedActionMenuDataProvider>
{
...
- (id)initWithStoriesDataSourceManager:(id)arg1 storyType:(long long)arg2 storyIdentifier:(id)arg3 unifiedProfileType:(unsigned long long)arg4;
