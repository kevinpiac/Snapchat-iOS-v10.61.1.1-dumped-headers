...
@interface SCCognacAppActiveCardController : NSObject <SCChatViewLifeCycleListener, SCCognacDataStorageUpdateListener, SCTV3CallStateListener, SCTV3ActiveConversationsListener, SCCognacAppActiveCardViewDelegate, SCCognacChatDockTransitionAnimatorDataSource>
{
