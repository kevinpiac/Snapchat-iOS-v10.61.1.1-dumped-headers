...
@class NSString, SCSearchNavigationCoordinator, SCSearchQuery, SCUserSession;

@interface SCCognacSendToSearchQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
