...
@class NSString, SCActionToolbarButtonItem, SCCameraToolbarItem, SCDisposableObserverLifecycle, SCExperimentManager, SCFeatureReference, SCLazy, SCLogger, SCManagedCapturerState, UIView;
...
- (id)initWithCapturer:(id)arg1 logger:(id)arg2 experimentManager:(id)arg3 applicationLifecycleEvents:(id)arg4 viewControllerLifecycleEvents:(id)arg5 mainCameraViewControllerLifecycleEvents:(id)arg6 cameraViewType:(long long)arg7 cameraUserActionLogger:(id)arg8;
