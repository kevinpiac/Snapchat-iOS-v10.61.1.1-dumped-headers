...
@class NSString, SCBatchCaptureCollectionViewController, SCBatchCaptureStateHandler, SCPreviewConfiguration, SCPreviewEphemeralMediaList, SCPreviewView, SCUserSession;
...
- (long long)_imageOrientationFromUI;
