...
@class NSString, NSUUID, SCAppNotification, SCLagunaFirmwareUpdateUserInfo, SCLagunaGetHdSessionInfo, SCLagunaOnboardingSessionInfo, SCSpectaclesConnectionInfo, SCSpectaclesDevice, SCSpectaclesFirmwareVersion;

@protocol SCSpectaclesAppLogger <NSObject>
- (void)logBoomboxSnapView:(NSString *)arg1 entryId:(NSString *)arg2 durationSec:(double)arg3 fileType:(long long)arg4 deviceId:(NSString *)arg5 firmwareVersion:(NSString *)arg6 hardwareVersion:(NSString *)arg7 deviceColor:(long long)arg8;
- (void)logBoomboxStoryView:(NSString *)arg1 durationSec:(double)arg2 numVideos:(unsigned long long)arg3 numPhotos:(unsigned long long)arg4 deviceId:(NSString *)arg5 firmwareVersion:(NSString *)arg6 hardwareVersion:(NSString *)arg7 deviceColor:(long long)arg8;
- (void)logCustomExportCancel:(NSString *)arg1 source:(long long)arg2 cancellationSource:(long long)arg3;
- (void)logCustomExportForContentId:(NSString *)arg1 source:(long long)arg2 action:(long long)arg3 shareChannel:(NSString *)arg4;
...
- (void)logRealTimeFirmwareUpdateFailureWithDeviceID:(NSString *)arg1 updateSessionID:(NSString *)arg2 firmwareVersion:(SCSpectaclesFirmwareVersion *)arg3 failureReason:(NSString *)arg4 updateIsActive:(_Bool)arg5;
- (void)logRealTimeFirmwareUpdateSuccessWithDeviceID:(NSString *)arg1 updateSessionID:(NSString *)arg2 newFirmwareVersion:(SCSpectaclesFirmwareVersion *)arg3 downloadDurationInMs:(long long)arg4 transferDurationInMs:(long long)arg5 updateDurationInMs:(long long)arg6 updateIsActive:(_Bool)arg7;
