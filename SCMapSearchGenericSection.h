...
@class NSArray, NSString, SCCollectionViewSectionUpdateModel, SCComposerPeopleFriendStore, SCEventListenerAnnouncer, SCMapSearchGenericSectionConfiguration, SCMapSearchSession, SCSearchQueryStateAwareSupplementaryViewProvider, SCSearchThresholdBasedModelContainer;
@protocol SCCollectionViewSectionDelegate, SCCollectionViewSectionLayoutProviding, SCComposerNetworkingClientProtocol, SCSearchIntentHandler;
