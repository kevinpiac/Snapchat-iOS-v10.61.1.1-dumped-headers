...
@class AVAsset, AVAssetReader, AVAssetReaderAudioMixOutput, AVAssetReaderTrackOutput, AVAssetWriter, AVAssetWriterInput, FBKVOController, NSArray, NSData, NSError, NSString, NSURL, SCImageProcessAssetWriterInputPixelBufferAdaptor, SCImageProcessQueue, SCImageProcessVideoExportMagicMomentConfig, SCVideoContentComplexityAnalyzer;
...
- (id)initWithQueue:(id)arg1 GPUCommands:(id)arg2 CPUCommands:(id)arg3 rightStereoGPUCommands:(id)arg4 leftStereoGPUCommands:(id)arg5 videoAsset:(id)arg6 backgroundAudioData:(id)arg7 overridingAudioData:(id)arg8 outputURL:(id)arg9 outputSize:(struct CGSize)arg10 outputPlaybackRate:(double)arg11 outputTimeRanges:(id)arg12 maxKeyFrameInterval:(unsigned long long)arg13 shouldLimitFrameRateForCameraRoll:(_Bool)arg14 outputBitrate:(double)arg15 transform:(struct CGAffineTransform)arg16 orientation:(long long)arg17 viewportTransform:(struct CGAffineTransform)arg18 cpuBufferTransform:(struct CGAffineTransform)arg19 audio:(_Bool)arg20 rawDataURL:(id)arg21 audioProcessingWrapper:(id)arg22 magicMomentConfig:(id)arg23;
