...
@class SCUnifiedProfileViewController, UIViewController;

@protocol SCProfileViewControllerDelegate <NSObject>
- (void)dismissProfileViewController:(UIViewController *)arg1;

@optional
- (void)dismissProfileViewController:(UIViewController *)arg1 animated:(_Bool)arg2 completionBlock:(void (^)(void))arg3;
