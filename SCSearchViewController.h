...
@interface SCSearchViewController : UIViewController <SCSearchInAppNotificationHandling, SCSearchViewDelegate, SCTraceEnabled, SCSearchNavigationCoordinatorDelegate, SCSearchNavigationBarDelegate, UIGestureRecognizerDelegate, SCSearchContentViewControlling, SCUpdateAnnouncing>
{
