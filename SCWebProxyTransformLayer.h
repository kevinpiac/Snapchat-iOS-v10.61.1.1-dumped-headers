...
@protocol SCWebProxyTransformLayerDelegate;

@interface SCWebProxyTransformLayer : SCWebProxyLayer
{
    id <SCWebProxyTransformLayerDelegate> _delegate;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) __weak id <SCWebProxyTransformLayerDelegate> delegate; // @synthesize delegate=_delegate;
