...
- (void).cxx_destruct;
- (void)_fetchDataAndRenderImageWithCompletion:(CDUnknownBlockType)arg1 contextData:(id)arg2 userSession:(id)arg3 displayName:(id)arg4 bitmojiManager:(id)arg5 bitmojiAvatarProvider:(id)arg6;
- (void)_onCacheMissWithContextData:(id)arg1 CFTimeInterval:(double)arg2 completion:(CDUnknownBlockType)arg3 contextFilterInput:(id)arg4 postCaptureLens:(id)arg5 userSession:(id)arg6 displayName:(id)arg7 bitmojiManager:(id)arg8 bitmojiAvatarProvider:(id)arg9;
