...
@class NSDate, NSString, SCSectionBasedCollectionViewUpdater, SCStoryManagementChromeViewController, SCStoryManagementDataSource, SCStoryManagementPlayerManager, SCStoryManagementSnapCollectionViewPagingController, SCStoryManagementSnapDataModel, SCStoryManagementView, UIGestureRecognizer;
@protocol SCActionHandling, SCImageDownloading, SCStoryManagementViewControllerDelegate;

@interface SCStoryManagementViewController : UIViewController <UICollectionViewDelegate, SCUpdateListener, SCStoryManagementChromeViewControllerDelegate, SCStoryManagementViewDelegate, SCShakeToReportDelegate, UIGestureRecognizerDelegate>
{
