...
@class NSArray, NSString, NSURL, SCMapExploreStatus, SCMapExplorerCarouselView, SCMapPerson, SCMapReplyMessageContent, UIView;
...
- (void)mapExplorerCarouselView:(SCMapExplorerCarouselView *)arg1 didLongPressOnStatus:(SCMapExploreStatus *)arg2;
- (void)mapExplorerCarouselView:(SCMapExplorerCarouselView *)arg1 didShowStatus:(SCMapExploreStatus *)arg2;
- (void)mapExplorerCarouselView:(SCMapExplorerCarouselView *)arg1 didTapStatus:(SCMapExploreStatus *)arg2;
...
- (void)mapExplorerCarouselView:(SCMapExplorerCarouselView *)arg1 willShowStatus:(SCMapExploreStatus *)arg2;
