...
@class NSArray, NSString, SCEventListenerAnnouncer, SCInviteFriendStateTracker, SCLazy;
@protocol NSCopying, SCImageDownloading, SCPerforming, SCSectionDataProvidingDelegate;

@interface SCAddFriendsContactNonSnapchatterSectionDataProvider : NSObject <SCInviteFriendStateListener, SCSnapchattersDataRequestListener, SCSectionDataProviding>
{
