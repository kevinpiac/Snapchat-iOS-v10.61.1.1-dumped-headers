...
@protocol SCAudioStitch, SCOperaBandwidthEstimator;
...
@property(readonly, nonatomic) _Bool timerViewEnabled; // @synthesize timerViewEnabled=_timerViewEnabled;
