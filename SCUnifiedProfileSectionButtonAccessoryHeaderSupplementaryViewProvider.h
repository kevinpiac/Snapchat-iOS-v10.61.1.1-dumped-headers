...
@class NSDictionary, NSString, SCUnifiedProfileSectionHeaderViewModel;
@protocol SCActionHandling, SCCollectionViewSectionSupplementaryViewProviderDelegate;

@interface SCUnifiedProfileSectionButtonAccessoryHeaderSupplementaryViewProvider : NSObject <SCCollectionViewSectionSupplementaryViewProviding, SCCollectionViewSupplementaryViewModelsConfigurable, SCActionable>
{
    SCUnifiedProfileSectionHeaderViewModel *_headerViewModel;
