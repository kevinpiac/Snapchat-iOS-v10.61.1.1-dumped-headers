...
+ (id)scanResultViewControllerForScanResults:(id)arg1 startChatDelegate:(id)arg2 userSession:(id)arg3 scanSourceInformation:(id)arg4 lensUnlockDelegate:(id)arg5;
...
- (id)_initWithUserSession:(id)arg1 scanResults:(id)arg2 scanSourceInformation:(id)arg3 lensUnlockDelegate:(id)arg4;
...
- (id)initWithScanResults:(id)arg1 scanSourceInformation:(id)arg2 userSession:(id)arg3 lensUnlockDelegate:(id)arg4;
