...
@class FBKVOController, NSString, SCDiscoverFeedMiniProfileHandler, SCDiscoverFeedSubscribeRequestHandler, SCEventListenerAnnouncer, SCLazy, SCMiniProfileActionHandler, SCOpenUnifiedProfileActionHandler, SCOperaViewController, SCPublicContentMiniProfileController, SCSearchFriendProvider, SCSearchStoryShareSession, SCStoryMiniProfileViewController, SCUserSession, Story;
