...
@class NSArray, NSString, NSUUID, SCARBarItem, SCDisposableObserverLifecycle, SCFeatureSceneIntelligenceAnalyticsController, SCFeatureSceneIntelligencePrivacyPrompter, SCLSIDebugInfoController, SCLSIUtilityLensesController, SCLazy, SCLensSceneIntelligenceController, SCPredefinedLensMetadataStore, SCVerticalSwipeHintView, UIGestureRecognizer, UIView;
@protocol SCCapturer, SCFeatureSceneIntelligenceLensDelegate, SCLensDataFetcher;
...
- (void)_activateOnlyForActiveUtilityContext:(id)arg1 point:(struct CGPoint)arg2;
- (void)_activateWithContexts:(id)arg1 point:(struct CGPoint)arg2;
